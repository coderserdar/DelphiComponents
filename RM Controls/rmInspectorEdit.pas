...
{$ifdef BD6}
uses {$IFNDEF rmDesign}DesignIntf, DesignEditors, TypInfo, {$ENDIF}Classes, Forms, ExtCtrls, StdCtrls, Controls,
  rmInspector, rmInspectorItems, windows, rmTreeNonView, Dialogs, rmTabs3x, rmLabel,
  ActnList;
{$else}
uses {$IFNDEF rmDesign}DsgnIntf, TypInfo, {$ENDIF}Classes, Forms, ExtCtrls, StdCtrls, Controls,
  rmInspector, rmInspectorItems, windows, rmTreeNonView, Dialogs, rmTabs3x, rmLabel,
  ActnList;
{$endif}
