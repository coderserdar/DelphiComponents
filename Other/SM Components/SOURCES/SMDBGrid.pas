...
type
  ...
  published
    ...
    property FooterText: TSMGString read FFooterText write FFooterText;
      ...
      begin
        ...
        begin
          ...
          begin
           ...
           Visible := Assigned(Column.Field) and (Column.Field.FieldKind = fkData) and Column.Filterable;
           if Visible then
             SetFocus;
           Exit;
         end;
...
begin
  ...
  begin
    ...
    begin
      ...
      if not Focused then
        NewBackground:= clInactiveCaption
      else
    ...
    begin
      ...
      begin
        ...
        begin
          ...
          if (FilterValue <> '') and Assigned(FOnFilterApply) then
            FOnFilterApply(Self, Field, FilterValue, Accept);
        end
      end;
      if not Accept then
        break;
