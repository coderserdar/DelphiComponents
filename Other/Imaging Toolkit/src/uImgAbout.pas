...
//----------------------------------------------------------------------------//
//
// $Log:  33282: uImgAbout.pas 
//
//    Rev 1.0    2014-05-18 20:35:18  mcm
unit uImgAbout;
...
var mcmImgAboutBox : TmcmImgAboutBox;
...
procedure TmcmImgAboutBox.OKButtonClick(Sender: TObject);
begin
  ModalResult := mrOk;
end; // TmcmImgAboutBox.OKButtonClick.

procedure TmcmImgAboutBox.FormCreate(Sender : TObject);
begin
  {$IFDEF ACTIVETWAIN}
  ...
  {$ENDIF}
  FDemoVer := False;
end; // TmcmImgAboutBox.FormCreate.


procedure TmcmImgAboutBox.FormDestroy(Sender : TObject);
begin
end; // TmcmImgAboutBox.FormDestroy.


procedure TmcmImgAboutBox.FormShow(Sender: TObject);
begin
  {$IFDEF MCMDEMO}
    // DefaultWait := 60000;
  {$ENDIF}
