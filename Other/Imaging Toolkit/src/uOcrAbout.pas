...
{$IFDEF VER220} {$DEFINE GE_DXE} {$ENDIF}  // DELPHI XE  >= VER220
{$IFDEF VER230} {$DEFINE GE_DXE2} {$ENDIF} // DELPHI XE2 >= VER220
{$IFDEF VER240} {$DEFINE GE_DXE2} {$ENDIF} // DELPHI XE3 >= VER220
{$IFDEF VER250} {$DEFINE GE_DXE2} {$ENDIF} // DELPHI XE4 >= VER220
{$IFDEF VER260} {$DEFINE GE_DXE2} {$ENDIF} // DELPHI XE5 >= VER220
{$IFDEF VER270} {$DEFINE GE_DXE2} {$ENDIF} // DELPHI XE6 >= VER220
{$IFDEF VER280} {$DEFINE GE_DXE2} {$ENDIF} // DELPHI XE7 >= VER220
...
var mcmOCRAboutBox : TmcmOCRAboutBox;
...
procedure TmcmOCRAboutBox.OKButtonClick(Sender: TObject);
begin
  ModalResult := mrOk;
end; // TmcmAboutBox.OKButtonClick.

procedure TmcmOCRAboutBox.FormCreate(Sender : TObject);
begin
  {$IFDEF ACTIVETWAIN}
...
procedure TmcmOCRAboutBox.FormDestroy(Sender : TObject);
begin
end; // TAboutBox.FormDestroy.


procedure TmcmOCRAboutBox.FormShow(Sender: TObject);
begin
  {$IFDEF MCMDEMO}
  {$ENDIF}
  ...
  {$IFNDEF ACTIVETWAIN}
    ...
    {$IFDEF CBUILDER}
      ProductName.Caption := defOCRCBuilderToolkit;
      URLProd.Caption   := defCBuilderURL;
      URLProd.URL       := defCBuilderURL;
    {$ELSE}
      ProductName.Caption := defOCRToolkit;
