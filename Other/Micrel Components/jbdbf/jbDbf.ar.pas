  ...
  case Lang of
    ...
    Spanish:
      begin
        ...
        msgNoPasswordMatch := 'Clave no válida';
        msgNotEnoughtCreateIdx := 'Imposible crear el índice IDX';
        msgIdxTableNotFound := 'Imposible abrir el índice IDX "%s"';
        msgErrorOnIdxTable := 'Error durante la lectura del índice IDX "%s"';
        msgIdxFieldNotFound := 'Campo índice "%s" no encontrado';
        msgFieldNotFound := 'El campo número %d no existe';
        msgFileIsTooLarge := 'Fichero demasiado grande';
        msgErrorOnWrite := 'Error durante la escritura de la tabla';
        msgFileTooRemote := 'La fecha del fichero no es válida';
        msgCannotOpenTable := 'Imposible abrir la tabla';
        msgCannotDeleteItem := 'Imposible cancelar el campo';
        msgCannotAddItem := 'Imposible añadir un nuevo campo';
        msgBadDefinitionOfField := 'La definición del campo es errónea';
        msgDuplicateInUnique := 'Valor duplicado en un indice univoco';
        msgErrorOnMemoOpen := 'Error durante la apertura del memo';
        prgMakeIndexSort := 'Ordenamiento del índice';
        prgWriteIndexSort := 'Escritura del índice';
