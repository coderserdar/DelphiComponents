...
procedure EndSync  (Handle : HSYNC; Stream : HSTREAM; data, user : DWORD); stdcall;
procedure LyricSync(Handle : HSYNC; Stream : HSTREAM; data, user : DWORD); stdcall;
procedure TextSync (Handle : HSYNC; Stream : HSTREAM; data, user : DWORD); stdcall;
  ...
  with TOpenDialog.Create(Self) do begin
    try
      ...
      if Execute then begin
        ...
        NewSoundfont.font := BASS_MIDI_FontInit(PChar(FileName), 0);  // open new soundfont
