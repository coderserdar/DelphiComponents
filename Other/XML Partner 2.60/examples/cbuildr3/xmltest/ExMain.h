...
__published:	// IDE-managed Components
    ...
    void __fastcall ParserCDATASection(TObject *oOwner, WideString sValue);
    ...
    void __fastcall ParserDocTypeDecl(TObject *oOwner, WideString sDecl,
          WideString sId0, WideString sId1);
    void __fastcall ParserEndDocument(TObject *Sender);
    void __fastcall ParserEndElement(TObject *oOwner, WideString sValue);
    ...
    void __fastcall ParserStartElement(TObject *oOwner, WideString sValue);
