...
VERSION = BCB.06.00
# ---------------------------------------------------------------------------
PROJECT = XMLPartner_PD61.bpl
OBJFILES = XMLPartner_PD61.obj XpReg.obj
RESFILES = XMLPartner_PD61.res XpReg.dcr
MAINSOURCE = XMLPartner_PD61.cpp
RESDEPEN = $(RESFILES)
LIBFILES = 
IDLFILES = 
IDLGENFILES = 
LIBRARIES = 
PACKAGES = rtl.bpi vcl.bpi XMLPartner_PR61.bpi designide.bpi
...
PFLAGS = -$Y- -$L- -$D- -$A8 -v -LUDesignIDE -JPHNE -M
RFLAGS = 
AFLAGS = /mx /w2 /zn
LFLAGS = -D"TurboPower XMLPartner Professional Designtime package - VCL61" -aa \
    -Tpp -Gpd -x -Gn -Gl -Gi
# ---------------------------------------------------------------------------
