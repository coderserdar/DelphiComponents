...
VERSION = BCB.06.00
# ---------------------------------------------------------------------------
PROJECT = XMLPartner_QR61.bpl
OBJFILES = XMLPartner_QR61.obj XpQFlBas.obj XpQFlHTM.obj XpQFlRTF.obj XpQFlXML.obj \
    XpQFOHsh.obj XpQXSLFO.obj XpQXSLPr.obj XpQXSLT.obj XpAbout.obj
RESFILES = XpQFlHTM.dcr XpQFlRTF.dcr XpQFlXML.dcr XpQXSLPr.dcr
MAINSOURCE = XMLPartner_QR61.cpp
RESDEPEN = $(RESFILES) XpAbout.xfm
LIBFILES = 
IDLFILES = 
IDLGENFILES = 
...
PACKAGES = vcl.bpi XMLPartner_CR61.bpi visualclx.bpi rtl.bpi bcbie.bpi
...
PATHOBJ = .;$(LIBPATH)
# ---------------------------------------------------------------------------
CFLAG1 = -O2 -H=c:\PROGRA~1\borland\CBUILD~2\lib\vcl60.csm -Hc -Vx -Ve -X- -a8 -b- \
    -k- -vi -c -tWM
IDLCFLAGS = -I$(BCB)\include -I$(BCB)\include\vcl -src_suffix cpp -DUsingCLX -boa
PFLAGS = -$Y- -$L- -$D- -$A8 -v -JPHNE -M -DUsingCLX
RFLAGS = 
AFLAGS = /mx /w2 /zn
LFLAGS = -D"TurboPower XMLPartner Professional Runtime package - VCL61" -aa \
    -Tpp -Gpr -x -Gn -Gl -Gi
# ---------------------------------------------------------------------------
