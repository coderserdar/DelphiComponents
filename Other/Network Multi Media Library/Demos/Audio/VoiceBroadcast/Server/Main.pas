...
uses
  ...
  DB, Grids, DBGrids, ActnList,
  NMMCustomServer, NMMCustomBroadcastServer,
  NMMCustomSimpleBroadcastServer, NMMVoiceBroadcastServer,
  Menus;
...
type
  TfrmMain = class(TForm)
    ...
    Server: TNMMVoiceBroadcastServer;
    edIP: TEdit;
    edPort: TEdit;
    Label2: TLabel;
    Label3: TLabel;
...
uses NMMScreenCapturer, UserList, ThreadInfo, WinSock, NoCodecDlg, NMMAudioCommon,
  BroadcastMessage{, PhoneSettings}, About;
