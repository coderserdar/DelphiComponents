object PSForm: TPSForm
  ...
  object lbFileFilter: TLabel
    ...
    Height = 13
    Caption = 
      'Supported file types (*.tbx, *.xml, *.htm)|*.tbx;*.xml;*.htm;*.h' +
      'tml|TBX Files (*.tbx)|*.tbx|XML Files (*.xml)|*.xml|HTML Files (' +
  ...
  object Panel1: TPanel
    ...
    object Label2: TLabel
      ...
      Width = 291
      Height = 13
      Caption = 'Configure options for TBX (Term Base eXchange) dictionaries'
    end
