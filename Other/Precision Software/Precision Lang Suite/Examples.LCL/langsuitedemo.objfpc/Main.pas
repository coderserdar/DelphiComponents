...
uses
  ...
  Dialogs, plsLangMan, StdCtrls, ExtCtrls, Menus, ComCtrls, rtlconsts;
...
begin
  MessageDlgLM(Caption,MSG_TEST2,mtWarning,mbYesNoCancel,mbNo);
end;
...
begin
  MessageDlgLM(Caption,SSelectDirCap,mtInformation,[mbOK]);
end;
