      ...
      { *****************************************************************}
      {                                                                  }
      { GDI+ Class with dynamic loading portion created by theMIROn      }
      {                                                                  }
...
//--------------------------------------------------------------------------
  ...
  begin
    bitmap := nil;
    lastResult := xGDIPAPI.GdipCreateBitmapFromDirectDrawSurface(surface, bitmap);
    SetNativeImage(bitmap);
  end;
