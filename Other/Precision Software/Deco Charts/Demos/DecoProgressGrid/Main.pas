...
type
  TForm3 = class(TForm)
    ...
    pMain: TPanel;
    DecoProgressGrid1: TDecoProgressGrid;
    Splitter1: TSplitter;
    DecoProgressGrid2: TDecoProgressGrid;
    Label12: TLabel;
    ...
    procedure miSortPercClick(Sender: TObject);
...
procedure TForm3.miSortPercClick(Sender: TObject);
begin
  DecoProgressGrid1.Sort;
  DecoProgressGrid2.Sort;
end;
...
begin
  if TDecoProgressGrid(Sender).IsCaptionHovered then
    ShowMessage('Grid caption has been clicked.')
  else
  if TDecoProgressGrid(Sender).IsColumnsHeaderHovered then
...
begin
  case ColumnIndex of
    ...
    3:if Item.Value>Item.MaxValue then
      TargetCanvas.Font.Color:=TDecoProgressGrid(Sender).Level3Color;
  end;
end;
