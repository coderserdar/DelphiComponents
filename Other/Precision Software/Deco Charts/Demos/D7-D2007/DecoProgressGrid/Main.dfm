object Form3: TForm3
  ...
  object pMain: TPanel
    ...
    object DecoProgressGrid1: TDecoProgressGrid
      Left = 0
      Top = 0
      Width = 515
      Height = 245
    ...
    object DecoProgressGrid2: TDecoProgressGrid
      Left = 0
      Top = 250
      Width = 515
      Height = 348
  ...
  object pumGrid: TPopupMenu
    ...
    object miSortPerc: TMenuItem
      Caption = 'Sort by percent'
      OnClick = miSortPercClick
    end
  end
end
