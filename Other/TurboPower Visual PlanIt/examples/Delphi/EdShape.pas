...
uses
  ...
  StdCtrls, Spin, ColorGrd, ExtCtrls, TypInfo,
...
//  AShape.Brush.Color := cgBrushColor.
//  AShape.Brush.Style :=
//  AShape.Pen.Color := cgPenColor.Color;
  AShape.Pen.Width := spedPenWidth.Value;
//  AShape.Pen.Style :=
//  AShape.Pen.Mode
end;
{=====}
...
begin
  ...
  { pen settings }
  spedPenWidth.Value := AShape.Pen.Width;
