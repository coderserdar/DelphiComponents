...
begin
  ...
  AddStr( 826, 'F&iltres...' );
  AddStr( 827, 'Vous pouvez définir des filtres pour sélectionner les fichiers à ajouter' );
  ...
  AddStr( 916, 'Filtrer les fichiers ?' );
  ...
  AddStr( 2200, 'Filtres' );
  AddStr( 2202, 'Ajouter' );
  AddStr( 2203, 'Modifier' );
  AddStr( 2204, 'Supprimer' );
  AddStr( 2205, 'Tout effacer' );
  AddStr( 2206, 'Type de filtre' );
  AddStr( 2207, 'Exiger'+#13+
                'Exclure' );
  AddStr( 2208, 'Modifier le filtre:' );
  AddStr( 2209, 'Ajouter un filtre:' );
end;
