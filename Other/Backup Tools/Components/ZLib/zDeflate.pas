...
{ ========================================================================= }
function deflateCopy (var dest, source : z_stream) : int;
{$ifndef MAXSEG_64K}
var
...
{$else}
  ...
  if (source = Z_NULL) or (dest = Z_NULL) or (ss = Z_NULL) then
  begin
    deflateCopy := Z_STREAM_ERROR;
    exit;
  end;
...
begin
  ...
  begin
    ...
    begin
      ...
      s.lookahead := uInt(Integer(s.strstart) - Integer(max_start));
