...
type
  ...
  private
    ...
    TriangleVertices: array[1..3] of TD3DVertex;
...
begin
  ...
  TriangleVertices [1] := MakeD3DVertex ( MakeD3DVector (-1, -1, 0), n0, 0, 0);
  TriangleVertices [2] := MakeD3DVertex ( MakeD3DVector (+1, -1, 0), n0, 1, 0);
  TriangleVertices [3] := MakeD3DVertex ( MakeD3DVector ( 0, +1, 0), n0, 0.5, 1);
end;
...
begin
  ...
  MatRotate := SetRotateYMatrix ( Counter );
end;
...
begin
  ...
  D3DUtil_InitMaterial (mtrl, 1.0, 1.0, 1.0, 1);
...
begin
  ...
  DXDraw1.D3DDevice7.DrawPrimitive(D3DPT_TRIANGLELIST, D3DFVF_VERTEX, TriangleVertices[1], 3, 0);
