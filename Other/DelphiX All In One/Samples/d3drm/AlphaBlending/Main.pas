...
var
  Texture: IDirect3DRMTexture2;
  LightFrame, MeshFrame: IDirect3DRMFrame;
  Light, AmbientLight: IDirect3DRMLight;
  MeshBuilder: IDirect3DRMMeshBuilder;
begin
  DXDraw.D3DRM2.LoadTexture(PChar(ExtractFilePath(Application.ExeName)+'back.bmp'), Texture);
  DXDraw.Scene.SetSceneBackgroundImage(Texture);
  ...
  MeshBuilder.SetColor(D3DRGBA(1, 1, 1, 0.5));  {!!!!!!!!!!!!!!!!!!!!!!!!!!!!}
