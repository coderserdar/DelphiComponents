...
const
  FtpCliVersion      = 707;
  CopyRight : String = ' TFtpCliW (c) 1996-2009 F. Piette V7.07 ';
  FtpClientId : String = 'ICS FTP Client V7.07 Wide';   { V2.113 sent with CLNT command  }
...
procedure Register;
begin
    RegisterComponents('FPiette', [TFtpClientW
{$IFDEF USE_SSL}
                       , TSslFtpClientW
{$ENDIF}
                       ]);
...
procedure TCustomFtpCliW.HandleBackGroundException(E: Exception);
var
    CanAbort : Boolean;
begin
    CanAbort := TRUE;
...
{* * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * *}
procedure TCustomFtpCliW.SetCodePage(const Value: Cardinal); { AG 7.02 }
begin
...
{* * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * *}
procedure TCustomFtpCliW.SetDataPortRangeStart(NewValue: DWORD); {JT}
begin
...
{* * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * *}
procedure TCustomFtpCliW.SetDataPortRangeEnd(NewValue: DWORD); {JT}
begin
    if NewValue > 65535 then
...
{* * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * *}
{$IFDEF UseBandwidthControl}
procedure TCustomFtpCliW.BandwidthTimerTimer(Sender : TObject);
begin
