...
procedure TForm1.onCopyEventW (LogLevel: TLogLevel ; Info: UnicodeString ;
                                                  var Cancel: boolean) ;
begin
...
procedure TForm1.onHttpEventW (LogLevel: TLogLevel ; Info: UnicodeString ;
                                                  var Cancel: boolean) ;
begin
    if (LogLevel = LogLevelInfo) or (LogLevel = LogLevelFile) then
    begin
...
procedure TForm1.onFtpEventW (LogLevel: TLogLevel ; Info: UnicodeString ;
                                                  var Cancel: boolean) ;
begin
    if (LogLevel = LogLevelInfo) or (LogLevel = LogLevelFile) then
    begin
