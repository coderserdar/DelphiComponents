...
// (DO NOT EDIT: machine generated header) 'DBGridEhFindDlgs.pas' rev: 4.00
...
public:
	...
	void __fastcall Excecute(Dbgrideh::TCustomDBGridEh* AGrid, AnsiString Text, AnsiString ColumnFieldName
		, TColumnFieldsArrEh ColumnFields, bool Modal);
	__property Dbgrideh::TCustomDBGridEh* Grid = {read=FGrid};
public:
	#pragma option push -w-inl
	/* TCustomForm.Create */ inline __fastcall virtual TDBGridEhFindDlg(Classes::TComponent* AOwner) : 
		Forms::TForm(AOwner) { }
	#pragma option pop
	#pragma option push -w-inl
	/* TCustomForm.CreateNew */ inline __fastcall virtual TDBGridEhFindDlg(Classes::TComponent* AOwner, 
...
public:
	#pragma option push -w-inl
	/* TWinControl.CreateParented */ inline __fastcall TDBGridEhFindDlg(HWND ParentWindow) : Forms::TForm(
		ParentWindow) { }
	#pragma option pop
...
typedef void __fastcall (*TExcecuteDBGridEhFindDialogProc)(Dbgrideh::TCustomDBGridEh* Grid, AnsiString 
	Text, AnsiString FieldName, TColumnFieldsArrEh ColumnFields, bool Modal);
...
extern PACKAGE void __fastcall ExcecuteDBGridEhFindDialog(Dbgrideh::TCustomDBGridEh* Grid, AnsiString 
	Text, AnsiString FieldName, TColumnFieldsArrEh ColumnFields, bool Modal);
