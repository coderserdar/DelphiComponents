...
// (DO NOT EDIT: machine generated header) 'PrViewEh.pas' rev: 4.00
...
public:
	#pragma option push -w-inl
	/* TWinControl.CreateParented */ inline __fastcall TDrawPanel(HWND ParentWindow) : Extctrls::TPanel(
		ParentWindow) { }
	#pragma option pop
...
public:
	#pragma option push -w-inl
	/* TWinControl.CreateParented */ inline __fastcall TPreviewBox(HWND ParentWindow) : Forms::TScrollBox(
		ParentWindow) { }
	#pragma option pop
