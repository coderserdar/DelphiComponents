...
// (DO NOT EDIT: machine generated header) 'RichEdEh.pas' rev: 4.00
...
protected:
	#pragma option push -w-inl
	/* TPropertyEditor.Create */ inline __fastcall TRichEditStringsEh(const Dsgnintf::_di_IFormDesigner 
