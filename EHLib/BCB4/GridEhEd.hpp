...
// (DO NOT EDIT: machine generated header) 'GridEhEd.pas' rev: 4.00
...
protected:
	#pragma option push -w-inl
	/* TPropertyEditor.Create */ inline __fastcall TDBGridEhColumnsProperty(const Dsgnintf::_di_IFormDesigner 
...
protected:
	#pragma option push -w-inl
	/* TPropertyEditor.Create */ inline __fastcall TDBGridEhFieldProperty(const Dsgnintf::_di_IFormDesigner 
...
protected:
	#pragma option push -w-inl
	/* TPropertyEditor.Create */ inline __fastcall TDBGridEhFieldAggProperty(const Dsgnintf::_di_IFormDesigner 
