...
__interface INTERFACE_UUID("{2A1F4552-15C3-4359-ADAB-F2F6719FAA97}") ILookupGridOwner  : public IUnknown 
...
//-- var, const, procedure ---------------------------------------------------
#define ColumnEhTitleValues (System::Set<TColumnEhValue, cvColor, cvDropDownShowTitles> () )
