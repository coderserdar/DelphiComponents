...
// (DO NOT EDIT: machine generated header) 'PropStorageEditEh.pas' rev: 5.00
...
__published:
	...
	void __fastcall TreeView1MouseDown(System::TObject* Sender, Controls::TMouseButton Button, Classes::TShiftState 
		Shift, int X, int Y);
	void __fastcall TreeView1MouseMove(System::TObject* Sender, Classes::TShiftState Shift, int X, int 
		Y);
	void __fastcall TreeView1MouseUp(System::TObject* Sender, Controls::TMouseButton Button, Classes::TShiftState 
		Shift, int X, int Y);
	...
	void __fastcall TreeView2MouseDown(System::TObject* Sender, Controls::TMouseButton Button, Classes::TShiftState 
		Shift, int X, int Y);
	...
	void __fastcall TreeView1Compare(System::TObject* Sender, Comctrls::TTreeNode* Node1, Comctrls::TTreeNode* 
...
protected:
	Comctrls::TTreeNode* __fastcall AddSortedChildObject(Comctrls::TTreeNode* Parent, const AnsiString 
		S, TNodeInfoEh* Data);
	...
	TNodeInfoEh* __fastcall CreateNodeInfo(Classes::TComponent* Component, AnsiString Name, AnsiString 
		Path, TNodeTypeEh NodeType, bool IsVoidProperty);
	...
	void __fastcall AddCollectionProperties(Comctrls::TTreeNode* N, Classes::TCollection* O, AnsiString 
		Path);
...
public:
	#pragma option push -w-inl
	/* TCustomForm.Create */ inline __fastcall virtual TPropStorageEditEhForm(Classes::TComponent* AOwner
		) : Forms::TForm(AOwner) { }
	#pragma option pop
	#pragma option push -w-inl
	/* TCustomForm.CreateNew */ inline __fastcall virtual TPropStorageEditEhForm(Classes::TComponent* AOwner
...
public:
	#pragma option push -w-inl
	/* TWinControl.CreateParented */ inline __fastcall TPropStorageEditEhForm(HWND ParentWindow) : Forms::TForm(
		ParentWindow) { }
	#pragma option pop
...
protected:
	#pragma option push -w-inl
	/* TPredifinedPropsEh.Create */ inline __fastcall virtual TPredifinedActiveControlEh(TPropStorageEditEhForm* 
		EditForm) : TPredifinedPropsEh(EditForm) { }
	#pragma option pop
...
protected:
	#pragma option push -w-inl
	/* TPredifinedPropsEh.Create */ inline __fastcall virtual TPredifinedPosPropertiesEh(TPropStorageEditEhForm* 
		EditForm) : TPredifinedPropsEh(EditForm) { }
	#pragma option pop
...
protected:
	#pragma option push -w-inl
	/* TPredifinedPropsEh.Create */ inline __fastcall virtual TPredifinedSizePropertiesEh(TPropStorageEditEhForm* 
		EditForm) : TPredifinedPropsEh(EditForm) { }
	#pragma option pop
...
protected:
	#pragma option push -w-inl
	/* TPredifinedPropsEh.Create */ inline __fastcall virtual TPredifinedStatePropertiesEh(TPropStorageEditEhForm* 
		EditForm) : TPredifinedPropsEh(EditForm) { }
	#pragma option pop
