...
procedure SIRegister_TCakDir2(CL: TPSPascalCompiler);
procedure SIRegister_CakDir2(CL: TPSPascalCompiler);

{ run-time registration functions }
procedure RIRegister_CakDir2_Routines(S: TIFPSExec);
procedure RIRegister_TCakDir2(CL: TPSRuntimeClassImporter);
procedure RIRegister_CakDir2(CL: TPSRuntimeClassImporter);
...
begin
  ...
  begin
    ...
    RegisterMethod('Function Archive_Contents( index : integer) : ContentType');
 ...
 //    CL.AddConstantN('LineBreak','Char').SetString( #10);
...
//   +'pe; BaseType : SupportType; Enabled : boolean; end');
 ...
 CL.AddConstantN('MaxArchiver','LongInt').SetInt( 40);
 CL.AddConstantN('TMPDIR','String').SetString( 'QZTEMP\');
 CL.AddConstantN('LEADCHAR','String').SetString( 'CAKE2.');
 CL.AddConstantN('PRODUCT','String').SetString( 'Quick Zip ');
 CL.AddConstantN('FUNCNOTAVIL','String').SetString( 'Function not avaliable');
 CL.AddConstantN('ACEINTERR','String').SetString( 'Ace Internal Error : File already Exists');
 CL.AddConstantN('NOERR','String').SetString( 'Operation OK');
 CL.AddConstantN('ABOUTSTR','String').SetString( 'Common Archiver Kit Experiment Ver 2' + #13#10 + '(c) Joseph Leung 2001 - http://qzip.cjb.net' + #13#10 + 'OpenSource under GNU Library License');
 CL.AddConstantN('CODE_NOERROR','LongInt').SetInt( 0);
 CL.AddConstantN('CODE_UNDEFERROR','LongInt').SetInt( 9999);
 CL.AddConstantN('CODE_PROCESSFAIL','LongInt').SetInt( 2999);
 CL.AddConstantN('CODE_PROCESSOK','LongInt').SetInt( 2001);
 CL.AddConstantN('CODE_PROCESSEXTR','LongInt').SetInt( 2002);
 CL.AddConstantN('CODE_PROCESSTEST','LongInt').SetInt( 2003);
 CL.AddConstantN('CODE_PROCESSADD','LongInt').SetInt( 2004);
 CL.AddConstantN('CODE_PROCESSREADD','LongInt').SetInt( 2005);
 CL.AddConstantN('CODE_PROCESSDEL','LongInt').SetInt( 2006);
 CL.AddConstantN('CODE_HOTEDIT','LongInt').SetInt( 3001);
 CL.AddConstantN('CODE_DLLERROR','LongInt').SetInt( 1001);
 CL.AddConstantN('CODE_NOTEXIST','LongInt').SetInt( 1002);
 CL.AddConstantN('CODE_PASSWORD','LongInt').SetInt( 1003);
 CL.AddConstantN('CODE_SFXHEADER','LongInt').SetInt( 1004);
 CL.AddConstantN('CODE_NOSUPPORT','LongInt').SetInt( 1005);
 CL.AddConstantN('CODE_LISTERROR','LongInt').SetInt( 1006);
 CL.AddConstantN('CODE_DLLNOTFOUND','LongInt').SetInt( 1007);
 CL.AddConstantN('CODE_CANTREAD','LongInt').SetInt( 1008);
 CL.AddConstantN('CODE_EXIST','LongInt').SetInt( 1009);
 CL.AddConstantN('CODE_USERSKIP','LongInt').SetInt( 1010);
 CL.AddConstantN('CODE_NOMEMORY','LongInt').SetInt( 1011);
 CL.AddConstantN('CODE_NOTSPECIFY','LongInt').SetInt( 1012);
 CL.AddConstantN('CODE_NOTFOUNDARC','LongInt').SetInt( 1013);
 CL.AddConstantN('CODE_NODISKSPACE','LongInt').SetInt( 1014);
 CL.AddConstantN('CODE_WRITE','LongInt').SetInt( 1015);
 CL.AddConstantN('CODE_CRC','LongInt').SetInt( 1016);
 CL.AddConstantN('CODE_READERROR','LongInt').SetInt( 1017);
 CL.AddConstantN('CODE_OPENED','LongInt').SetInt( 1018);
 CL.AddConstantN('CODE_VOLUMECHANGE','LongInt').SetInt( 1019);
 CL.AddConstantN('CODE_READONLY','LongInt').SetInt( 1020);
 CL.AddConstantN('CODE_UNKTYPE','LongInt').SetInt( 1021);
 CL.AddConstantN('CODE_LONGFN','LongInt').SetInt( 1022);
 CL.AddConstantN('CODE_WRONGVER','LongInt').SetInt( 1023);
 CL.AddConstantN('CODE_NEWER','LongInt').SetInt( 1024);
 CL.AddConstantN('CODE_TOOMANYFILE','LongInt').SetInt( 1025);
 CL.AddConstantN('CODE_MAKEDIR','LongInt').SetInt( 1026);
 CL.AddConstantN('CODE_HUFFAN','LongInt').SetInt( 1027);
 CL.AddConstantN('CODE_HEADER','LongInt').SetInt( 1028);
 CL.AddConstantN('CODE_CRCHEADER','LongInt').SetInt( 1029);
 CL.AddConstantN('CODE_HEADERBROKE','LongInt').SetInt( 1030);
 CL.AddConstantN('CODE_NOTARC','LongInt').SetInt( 1031);
 CL.AddConstantN('CODE_WRONGTYPE','LongInt').SetInt( 1032);
 CL.AddConstantN('CODE_WRONGCMD','LongInt').SetInt( 1033);
 CL.AddConstantN('CODE_MOREHEAP','LongInt').SetInt( 1034);
 CL.AddConstantN('CODE_RUNNING','LongInt').SetInt( 1035);
 CL.AddConstantN('CODE_HARC','LongInt').SetInt( 1036);
 CL.AddConstantN('CODE_SEARCH','LongInt').SetInt( 1037);
 CL.AddConstantN('CODE_TIMESTAMP','LongInt').SetInt( 1038);
 CL.AddConstantN('CODE_ARCREADONLY','LongInt').SetInt( 1039);
 CL.AddConstantN('CODE_TMPOPEN','LongInt').SetInt( 1040);
 CL.AddConstantN('CODE_SAMENAME','LongInt').SetInt( 1041);
 CL.AddConstantN('CODE_NORESPONSE','LongInt').SetInt( 1042);
 CL.AddConstantN('CODE_NOTVALID','LongInt').SetInt( 1043);
 CL.AddConstantN('CODE_COPYTEMP','LongInt').SetInt( 1044);
 CL.AddConstantN('CODE_EOF','LongInt').SetInt( 1045);
 CL.AddConstantN('CODE_CANTCREATE','LongInt').SetInt( 1046);
 CL.AddConstantN('CODE_DISKFULL','LongInt').SetInt( 1047);
 CL.AddConstantN('ERR_UNDEFERROR','String').SetString( 'Unknown error');
 CL.AddConstantN('ERR_NOERROR','String').SetString( 'OK');
 CL.AddConstantN('ERR_DLLERROR','String').SetString( 'Internal error (related to dll)');
 CL.AddConstantN('ERR_LISTERROR','String').SetString( 'Internal error (cant list)');
 CL.AddConstantN('ERR_SFXHEADER','String').SetString( 'Problem copying SFX header');
 CL.AddConstantN('ERR_DLLNOTFOUND','String').SetString( 'Internal error (required dll not found)');
 CL.AddConstantN('ERR_NOTSPECIFY','String').SetString( 'No file specified.');
 CL.AddConstantN('ERR_READERROR','String').SetString( 'Read Error');
 CL.AddConstantN('ERR_VOLUMECHANGE','String').SetString( 'Volume change %s');
 CL.AddConstantN('ERR_TIMESTAMP','String').SetString( 'Wrong timestamp');
 CL.AddConstantN('ERR_PROCESSOK','String').SetString( 'Processing %s Correctly');
 CL.AddConstantN('ERR_PROCESSEXTR','String').SetString( 'Extracting %s');
 CL.AddConstantN('ERR_PROCESSTEST','String').SetString( 'Testing %s');
 CL.AddConstantN('ERR_PROCESSADD','String').SetString( 'Compressing %s');
 CL.AddConstantN('ERR_PROCESSREADD','String').SetString( 'Re-Compressing %s');
 CL.AddConstantN('ERR_PROCESSDEL','String').SetString( 'Deleting %s');
 CL.AddConstantN('ERR_PROCESSFAIL','String').SetString( 'Processing %s with Error');
 CL.AddConstantN('ERR_HOTEDIT','String').SetString( 'File with path, cannot HotEdit');
 CL.AddConstantN('ERR_NODISKSPACE','String').SetString( 'Out of Disk space');
 CL.AddConstantN('ERR_READONLY','String').SetString( 'Read Only');
 CL.AddConstantN('ERR_USERSKIP','String').SetString( 'User Skip');
 CL.AddConstantN('ERR_CRC','String').SetString( 'CRC Error');
 CL.AddConstantN('ERR_UNKTYPE','String').SetString( 'Unknown File type');
 CL.AddConstantN('ERR_NOSUPPORT','String').SetString( 'Method not support');
 CL.AddConstantN('ERR_PASSWORD','String').SetString( 'Wrong password');
 CL.AddConstantN('ERR_LONGFN','String').SetString( 'This archive type dont support long filename');
 CL.AddConstantN('ERR_WRONGVER','String').SetString( 'Wrong Version');
 CL.AddConstantN('ERR_OPENED','String').SetString( 'File Opened');
 CL.AddConstantN('ERR_NEWER','String').SetString( 'Current file are newer');
 CL.AddConstantN('ERR_NOTEXIST','String').SetString( 'File not exist');
 CL.AddConstantN('ERR_EXIST','String').SetString( 'File already exist');
 CL.AddConstantN('ERR_TOOMANYFILE','String').SetString( 'Too Many files');
 CL.AddConstantN('ERR_MAKEDIR','String').SetString( 'Require make directory');
 CL.AddConstantN('ERR_WRITE','String').SetString( 'Cannot write');
 CL.AddConstantN('ERR_HUFFAN','String').SetString( 'Huffan code');
 CL.AddConstantN('ERR_HEADER','String').SetString( 'Problem reading comment header');
 CL.AddConstantN('ERR_CRCHEADER','String').SetString( 'Problem reading CRC header');
 CL.AddConstantN('ERR_HEADERBROKE','String').SetString( 'Header broken');
 CL.AddConstantN('ERR_NOTARC','String').SetString( 'Not an archive');
 CL.AddConstantN('ERR_CANTREAD','String').SetString( 'Can`t Read');
 CL.AddConstantN('ERR_WRONGTYPE','String').SetString( 'Wrong file style');
 CL.AddConstantN('ERR_WRONGCMD','String').SetString( 'Wrong command name');
 CL.AddConstantN('ERR_MOREHEAP','String').SetString( 'More heap memory');
 CL.AddConstantN('ERR_NOMEMORY','String').SetString( 'Not enough memory');
 CL.AddConstantN('ERR_RUNNING','String').SetString( 'Already Running');
 CL.AddConstantN('ERR_HARC','String').SetString( 'HARC havent opened');
 CL.AddConstantN('ERR_SEARCH','String').SetString( 'Not in search mode');
 CL.AddConstantN('ERR_ARCREADONLY','String').SetString( 'Archive read only');
 CL.AddConstantN('ERR_TMPOPEN','String').SetString( 'Unknown error ERROR_TMP_OPEN');
 CL.AddConstantN('ERR_SAMENAME','String').SetString( 'File with same name');
 CL.AddConstantN('ERR_NOTFOUNDARC','String').SetString( 'Cant find Archive file');
 CL.AddConstantN('ERR_NORESPONSE','String').SetString( 'Unknown error ERROR_RESPONSE_READ');
 CL.AddConstantN('ERR_NOTVALID','String').SetString( 'Not valid filename');
 CL.AddConstantN('ERR_COPYTEMP','String').SetString( 'Unable to copy to temp');
 CL.AddConstantN('ERR_EOF','String').SetString( 'End of file');
 CL.AddConstantN('ERR_CANTCREATE','String').SetString( 'Cannot Create');
 CL.AddConstantN('ERR_DISKFULL','String').SetString( 'Disk Full');
 CL.AddConstantN('MSG_PWD','String').SetString( 'Password');
 CL.AddConstantN('MSG_PLZENTERPWD4','String').SetString( 'Please Enter password for ');
 CL.AddConstantN('MSG_SHOWAGAIN','String').SetString( 'Show this dialog again next time');
 CL.AddConstantN('MSG_BEGINLOG','String').SetString( 'Begin Log');
 CL.AddConstantN('METHODNOTSUPPORT','String').SetString( 'Ace Compress Method not support ');
 CL.AddConstantN('Archive','String').SetString( 'Archives');
 CL.AddConstantN('SPACE','String').SetString( ' ');
 CL.AddConstantN('WINEXT_ZIP','String').SetString( 'ZIP');
 CL.AddConstantN('WINEXT_CAB','String').SetString( 'CAB');
 CL.AddConstantN('WINEXT_LHA','String').SetString( 'LZH');
 CL.AddConstantN('WINEXT_ARJ','String').SetString( 'ARJ');
 CL.AddConstantN('WINEXT_ACE','String').SetString( 'ACE');
 CL.AddConstantN('WINEXT_RAR','String').SetString( 'RAR');
 CL.AddConstantN('WINEXT_TAR','String').SetString( 'TGZ');
 CL.AddConstantN('WINEXT_BZ2','String').SetString( 'BZI');
 CL.AddConstantN('SEVENZIPDLL','String').SetString( '7-ZIP32.DLL');
 CL.AddConstantN('BZADLL','String').SetString( 'BGA32.DLL');
 CL.AddConstantN('BZ2DLL','String').SetString( 'BZ2LIB.DLL');
 CL.AddConstantN('BELDLL','String').SetString( 'UNBEL32.DLL');
 CL.AddConstantN('GCADLL','String').SetString( 'UNGCA32.DLL');
 CL.AddConstantN('LHADLL','String').SetString( 'UNLHA32.DLL');
 CL.AddConstantN('UNARJDLL','String').SetString( 'UNARJ32J.DLL');
 CL.AddConstantN('ZIPDLL','String').SetString( 'ZIPDLL.DLL');
 CL.AddConstantN('UNZIPDLL','String').SetString( 'UNZDLL.DLL');
 CL.AddConstantN('UNACEDLL','String').SetString( 'UNACE.DLL');
 CL.AddConstantN('UNRARDLL','String').SetString( 'UNRAR32.DLL');
 CL.AddConstantN('TARDLL','String').SetString( 'TAR32.DLL');
 CL.AddConstantN('YZ1DLL','String').SetString( 'YZ1.DLL');
 CL.AddConstantN('SQXDLL','String').SetString( 'SQX.DLL');
 CL.AddConstantN('MAJORVER','String').SetString( '2');
 CL.AddConstantN('MINORVER','String').SetString( '0');
 CL.AddConstantN('BUILD','String').SetString( '10');
 CL.AddConstantN('DefaultTreatAsZip','String').SetString( '.ZIP .PK3 .JAR .WSZ .SIT .EAR .WAR');
 CL.AddConstantN('DefaultTreatAsRar','String').SetString( '.RAR');
 CL.AddConstantN('DefaultTreatAsCab','String').SetString( '.CAB');
 CL.AddConstantN('DefaultTreatAsLha','String').SetString( '.LHA .LZH');
 CL.AddConstantN('DefaultTreatAsArj','String').SetString( '.ARJ');
 CL.AddConstantN('DefaultTreatAsAce','String').SetString( '.ACE');
 CL.AddConstantN('DefaultTreatAsTar','String').SetString( '.TAZ .TAR .RPM');
 CL.AddConstantN('DefaultTreatAsTgz','String').SetString( '.TGZ .GZ .Z');
 CL.AddConstantN('DefaultTreatAsBz2','String').SetString( '.BZ2 .TB2');
 CL.AddConstantN('DefaultTreatAsBza','String').SetString( '.BZA .GZA');
 CL.AddConstantN('DefaultTreatAsCzip','String').SetString( '.CZIP');
 CL.AddConstantN('DefaultTreatAsRs','String').SetString( '.RS');
 CL.AddConstantN('DefaultTreatAsYz1','String').SetString( '.YZ1');
 CL.AddConstantN('DefaultTreatAsUue','String').SetString( '.UUE .UU .ENC');
 CL.AddConstantN('DefaultTreatAsXxe','String').SetString( '.XXE');
 CL.AddConstantN('DefaultTreatAsB64','String').SetString( '.B64');
 CL.AddConstantN('DefaultTreatAsPak','String').SetString( '.PAK .WAD');
 CL.AddConstantN('DefaultTreatAsBel','String').SetString( '.BEL');
 CL.AddConstantN('DefaultTreatAsGcA','String').SetString( '.GCA');
 CL.AddConstantN('DefaultTreatAsQze','String').SetString( '.QZE');
 CL.AddConstantN('DefaultTreatAsAks','String').SetString( '.AKS');
 CL.AddConstantN('DefaultTreatAs7z','String').SetString( '.7Z .7ZIP');
 CL.AddConstantN('DefaultTreatAsHog','String').SetString( '.HOG');
 CL.AddConstantN('DefaultTreatAsPgp','String').SetString( '.PGP');
 CL.AddConstantN('DefaultTreatAsSqx','String').SetString( '.SQX');
 CL.AddConstantN('Totalcolumns','LongInt').SetInt( 9);
 CL.AddConstantN('TotalMeta','LongInt').SetInt( 18);
 CL.AddTypeS('TVariabletype','(aInteger, aString, aBoolean)');
 CL.AddTypeS('ContentType', 'record _FileRatio : Word; _FileIcon : Word; _Tag '
   +': Word; _FileSize : LongWord; _FilePackedSize : LongWord; _FileTime : TDate'
   +'time; _FileCRC : string; _FileName : string; _FileFullPath : string; _FileD'
   +'efPath : string; _FileArchive : String; _Filetype : string; _Encrypted : B'
   +'oolean; _Selected : Boolean; end');
  CL.AddTypeS('SupportType', '( _Zip, _Rar, _Cab, _Arj, _Lha, _Tar, _Tgz, _Ace,'
   +' _Bz2, _Bel, _Gca, _Bza, _Rs, _Czip, _Yz1, _Uue, _Xxe, _B64, _Pak, _Ext, _'
   +'7z, _Sqx, _Hog, _Qze, _Aks, _WIT, _PGP )');
  CL.AddTypeS('FileListType', '( _RawTxt, _Txt, _Htm, _Htm2, _Pdf, _Pdf2, _Csv '
   +')');
  CL.AddTypeS('SortByType', '( _FName, _FType, _FSize, _FPSize, _FCRC, _FRatio,'
   +' _FDefPath, _FTime, _FArchive )');
  CL.AddTypeS('CabModeType', '( _CFList, _CFExtract )');
  CL.AddTypeS('AddModeTypeList', '( _refresh, _update, _move )');
  CL.AddTypeS('AddModeType', 'set of AddModeTypeList;');
  CL.AddTypeS('MessageType', '( Msg_OK, Msg_Error, Msg_Warning, Msg_Unknown )');
  CL.AddTypeS('FileListItemType', '( Fl_fext, Fl_fname, Fl_ftype, Fl_fsize, Fl_'
   +'fdate, Fl_fPsize, Fl_fCRC, Fl_fratio, Fl_fdefpath )');
  CL.AddTypeS('FileListItemTypes', 'set of FileListItemType');
  CL.AddTypeS('EncryptMethodType', '( ceCZip, ceBlowFish, ceRijndael, ceTwoFish'
   +', qeBlowfish, qeDes, qe3des, qeRijndael )');
  CL.AddTypeS('TCOverEvent', 'Procedure ( Sender : TObject; FileName : string; '
   +'var overwrite : Boolean; var applytoall : Boolean)');
  CL.AddTypeS('TCPwdEvent', 'Procedure ( Sender : TObject; archive, FileName : '
   +'string; var newpassword : string)');
  CL.AddTypeS('TCCZIPPwdEvent', 'Procedure ( Sender : TObject; archive, FileNam'
   +'e : string; var key1, key2, key3 : integer)');
  CL.AddTypeS('TCMsgEvent', 'Procedure ( Sender : TObject; CErrCode, ErrCode : '
   +'Integer; Msgtype : MessageType; Message : string)');
  CL.AddTypeS('TCProgEvent', 'Procedure ( Sender : TObject; FileName : string; '
   +'FileSize : Longint; JustCompleted : Longint)');
  CL.AddTypeS('TCFoundEvent', 'Procedure ( Sender : TObject; FileName : string;'
   +' FileSize : Integer)');
  CL.AddTypeS('TCCrytoEvent', 'Procedure ( Sender : TObject; var Key1, Key2, Ke'
   +'y3 : Integer)');
  CL.AddTypeS('TCUnkCmdEvent', 'Procedure ( Sender : TObject; command : string;'
   +' param : TStrings)');
  CL.AddTypeS('TCReqColumnCaptionEvent', 'Procedure ( Sender : TObject; Column '
   +': integer; var Caption : string)');
  CL.AddTypeS('ArcType', 'record _ArcName : string; _ArcType : SupportType; _Ar'
   +'cSize : Integer; _ArcHaveInst : integer; _ArcHaveComm : Integer; _ArcNeedP'
   +'assword : Boolean; _ArcTime : TDatetime; end');
  CL.AddTypeS('FileListOptionsType', 'record Item2Show : FileListItemTypes; Bac'
   +'kgroundColor : TColor; HeaderFontColor : TColor; HeaderBackground : TColor'
   +'; FListBackground : TColor; NormalFontColor : TColor; SizeInK : Boolean; U'
   +'seBorder : Boolean; end');
  CL.AddTypeS('SfxOptionsType', 'record Sfx_To : Integer; Sfx_Message : string;'
   +' Sfx_CommandLine : string; Sfx_Caption : string; Sfx_ExtractTo : string; S'
   +'fx_AutoRun : Boolean; Sfx_Overwrite : Boolean; end');
  CL.AddTypeS('ExtractOptionsType', 'record Extr_to : string; Extr_DirNames : B'
   +'oolean; Extr_Overwrite : Boolean; Extr_ArcInArc : Boolean; Extr_ExtractAll'
   +' : Boolean; end');
  CL.AddTypeS('AddOptionsType', 'record Add_To : Integer; Add_DictSize : Intege'
   +'r; Add_Encrypt : string; Add_SubDir : Boolean; Add_UseEncrypt : Boolean; A'
   +'dd_UsePath : Boolean; Add_Mode : AddModeType; Add_Hidden : Boolean; Add_Fi'
   +'leList : Boolean; Add_Files : TStrings; Add_BaseDir : string; Add_Exclude '
   +': TStrings; Add_DosFormat : Boolean; Add_Relative : Boolean; Add_CompLevel'
   +' : integer; end');
  CL.AddTypeS('RenameOptionsType', 'record Rename_From : string; Rename_To : st'
   +'ring; RenameNow : boolean; end');
  CL.AddTypeS('EncryptoptionsType', 'record EncryptMethod : EncryptMethodType; '
   +'File2Encrypt : string; end');
  CL.AddTypeS('FinderOptionsType', 'record Af_TargetName : TStrings; Af_SourceD'
   +'ir : string; Af_SubDir : Boolean; Af_ArcFilter : string; Af_ArcType : set '
   +'of SupportType; Af_ContainText : string; Af_Text2Look : string; end');
  CL.AddTypeS('WorkType', '( wtNone, wtLoadContents, wtExtract, wtTest, wtAdd, '
   +'wtDelete, wtSfx, wtRename, wtEncrypt, wtClose )');
  CL.AddTypeS('SupportWorkType', 'set of WorkType');
  CL.AddTypeS('ShortcutType', '( stDESKTOP, stQUICKLAUNCH, stSENDTO, stSTARTMEN'
   +'U, stPROGRAMS, stOTHERFOLDER )');
  CL.AddTypeS('CZKeyType', 'record Part1 : integer; Part2 : integer; Part3 : In'
   +'teger; end');
...
(*----------------------------------------------------------------------------*)
Procedure TCakDir2List_P(Self: TCakDir2;  Mask : string; Subdir : boolean);
...
begin
  ...
  begin
    ...
    RegisterMethod(@TCakDir2.ArchiveContents, 'Archive_Contents');
...
{ TIFPS3CE_CakDir2 }
(*----------------------------------------------------------------------------*)
procedure TIFPS3CE_CakDir2.CompOnUses(CompExec: TPSScript);
begin
  { nothing } 
end;
(*----------------------------------------------------------------------------*)
procedure TIFPS3CE_CakDir2.ExecOnUses(CompExec: TPSScript);
begin
  { nothing } 
end;
(*----------------------------------------------------------------------------*)
procedure TIFPS3CE_CakDir2.CompileImport1(CompExec: TPSScript);
begin
  SIRegister_CakDir2(CompExec.Comp);
end;
(*----------------------------------------------------------------------------*)
procedure TIFPS3CE_CakDir2.CompileImport2(CompExec: TPSScript);
begin
  { nothing } 
end;
(*----------------------------------------------------------------------------*)
procedure TIFPS3CE_CakDir2.ExecImport1(CompExec: TPSScript; const ri: TPSRuntimeClassImporter);
begin
  RIRegister_CakDir2(ri);
  RIRegister_CakDir2_Routines(CompExec.Exec); // comment it if no routines
end;
(*----------------------------------------------------------------------------*)
procedure TIFPS3CE_CakDir2.ExecImport2(CompExec: TPSScript; const ri: TPSRuntimeClassImporter);
begin
  { nothing } 
end;
