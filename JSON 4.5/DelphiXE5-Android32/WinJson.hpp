...
// (DO NOT EDIT: machine generated header) 'WinJson.pas' rev: 26.00 (Android)
...
public:
	...
	/* Exception.CreateResFmt */ inline __fastcall EJsonError(System::PResStringRec ResStringRec, System::TVarRec const *Args, const int Args_Size) : System::Sysutils::Exception(ResStringRec, Args, Args_Size) { }
	...
	/* Exception.CreateResFmtHelp */ inline __fastcall EJsonError(System::PResStringRec ResStringRec, System::TVarRec const *Args, const int Args_Size, int AHelpContext) : System::Sysutils::Exception(ResStringRec, Args, Args_Size, AHelpContext) { }
...
public:
	...
	System::DynamicArray<System::Byte> __fastcall ToUtf8(bool PrettyPrint = true, bool UseTabChar = false, int TabSize = 0x2);
