...
// (DO NOT EDIT: machine generated header) 'WinJson.pas' rev: 27.00 (Android)
...
public:
	...
	/* Exception.CreateResFmt */ inline __fastcall EJsonError(System::PResStringRec ResStringRec, System::TVarRec const *Args, const int Args_High) : System::Sysutils::Exception(ResStringRec, Args, Args_High) { }
	...
	/* Exception.CreateResFmtHelp */ inline __fastcall EJsonError(System::PResStringRec ResStringRec, System::TVarRec const *Args, const int Args_High, int AHelpContext) : System::Sysutils::Exception(ResStringRec, Args, Args_High, AHelpContext) { }
