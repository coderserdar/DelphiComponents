...
uses SysUtils, Classes, Graphics, Controls, Forms, TypInfo, RxVCLUtils;
...
{$ENDIF}
    ...
    if (S <> '') or (PropInfo^.PropType^.Kind in [tkString
      ...
      tkWChar, tkWString {$ENDIF WIN32}]) then
...
const
  Precisions: array[TFloatType] of Integer = (7, 15, 18, 18{$IFDEF WIN32}, 19{$ENDIF});
begin
