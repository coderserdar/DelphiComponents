...
begin
  ...
  if stWholeWord in Options then Flags := Flags or {$IFNDEF RX_D14}FT_WHOLEWORD{$ELSE}CommDlg.FR_WHOLEWORD{$ENDIF};
  if stMatchCase in Options then Flags := Flags or {$IFNDEF RX_D14}FT_MATCHCASE{$ELSE}CommDlg.FR_MATCHCASE{$ENDIF};
