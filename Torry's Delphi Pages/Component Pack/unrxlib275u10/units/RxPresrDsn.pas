...
{$ELSE}
uses WinTypes, WinProcs, RxStr16, BoxProcs, TypInfo, RXLConst;
{$ENDIF}
...
begin
  ...
  begin
    for I := 0 to FCompOwner.ComponentCount - 1 do begin
      ...
      if StringsOnly then
         List := TPropInfoList.Create(C, [tkString,tkLString,tkWString])
      else
...
// method added by eddy
procedure TFormPropsDlg.StringsBoxClick(Sender: TObject);
var
   list: TStringList;
begin
