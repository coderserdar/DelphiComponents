...
const
  // Polaris begin
  BaseColorsNum = 16;
  ColorsInList = BaseColorsNum+{$IFDEF WIN32}30{28}{$ELSE}26{24}{$ENDIF};
  ColorValues: array [0..ColorsInList - 1] of TColor = (
    ...
    clGrayText, clBtnText, clInactiveCaptionText, clBtnHighlight,{$IFDEF WIN32} cl3DDkShadow, cl3DLight,
  ...
  ColorNamesEx : array [0..ColorsInList - 1] of Integer = (
    ...
    SColorGrayText, SColorBtnText, SColorInactiveCaptionText, SColorBtnHighlight,{$IFDEF WIN32} SColor3DDkShadow, SColor3DLight,
