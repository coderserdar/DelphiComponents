...
override PACKAGE_NAME=lazextcomponents
...
override TARGET_UNITS+=lazextcomponents.pas
endif
...
ifeq ($(FULL_TARGET),i386-linux)
override COMPILER_OPTIONS+=-dLCL -dLCL$(LCL_PLATFORM) -MObjFPC -Sgi
endif
ifeq ($(FULL_TARGET),i386-go32v2)
override COMPILER_OPTIONS+=-dLCL -dLCL$(LCL_PLATFORM) -MObjFPC -Sgi
endif
...
ifeq ($(FULL_TARGET),i386-linux)
override COMPILER_INCLUDEDIR+=composants/ ./
endif
ifeq ($(FULL_TARGET),i386-go32v2)
override COMPILER_INCLUDEDIR+=composants/ ./
endif
