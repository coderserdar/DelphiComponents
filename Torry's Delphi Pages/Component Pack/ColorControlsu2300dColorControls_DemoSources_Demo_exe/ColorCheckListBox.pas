...
uses
  Windows, Messages, SysUtils, Classes, Controls, StdCtrls, CheckLst, ColorPresets, Graphics;
...
procedure TColorCheckListBox.CMEnter(var Message: TCMEnter);
begin
  Invalidate;  
  inherited;
end;

procedure TColorCheckListBox.CMExit(var Message: TCMExit);
begin
  Invalidate;  
  inherited;
end;
...
procedure TColorCheckListBox.DrawItem(Index: Integer; Rect: TRect;
...
function TColorCheckListBox.GetColorPresets: TColorPresets;
begin
  Result := fColorPresets;
end;

procedure TColorCheckListBox.Notification(AComponent: TComponent;
...
procedure TColorCheckListBox.Resize;
begin
  inherited;
  Invalidate;
...
procedure TColorCheckListBox.SetColorPresets(const Value: TColorPresets);
begin
