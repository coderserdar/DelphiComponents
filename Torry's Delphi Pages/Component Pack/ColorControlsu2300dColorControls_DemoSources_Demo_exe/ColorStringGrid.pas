...
function TColorStringGrid.CellSelected(ARow, ACol: Integer;
...
procedure TColorStringGrid.CMEnter(var Message: TCMEnter);
begin
  inherited;
  Invalidate;
end;

procedure TColorStringGrid.CMExit(var Message: TCMExit);
begin
  inherited;
  Invalidate;
end;
...
procedure TColorStringGrid.DrawCell(ACol, ARow: Integer; ARect: TRect; AState: TGridDrawState);
...
function TColorStringGrid.GetColorPresets: TColorPresets;
begin
  Result := fColorPresets;
end;

procedure TColorStringGrid.Notification(AComponent: TComponent;
...
procedure TColorStringGrid.SetColorPresets(const Value: TColorPresets);
begin
  if value = nil then
    if Assigned(ColorPresets) then ColorPresets.DeleteOwner(self);
  fColorPresets := value;
