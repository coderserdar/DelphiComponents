...
type
  ...
  public
    ...
    procedure AddChange(ItemReason: TKHexEditorChangeReason; const Data: string = '';
  ...
  protected
    ...
    procedure AddUndoString(ItemReason: TKHexEditorChangeReason; const S: string;
      Inserted: Boolean = True);
...
function BinaryToDigits(Buffer: PBytes; SelStart, SelEnd: TKHexEditorSelection): string;
...
function BinaryToText(Buffer: PBytes; SelStart, SelEnd: Integer;
  CharMapping: PKEditCharMapping): string;
...
procedure TKCustomHexEditor.AddUndoString(ItemReason: TKHexEditorChangeReason;
  const S: string; Inserted: Boolean = True);
begin
  if S <> '' then
    FUndoList.AddChange(ItemReason, S, Inserted);
end;
...
procedure TKCustomHexEditor.InsertString(At: Integer; Value: string; Size: Integer);
begin
