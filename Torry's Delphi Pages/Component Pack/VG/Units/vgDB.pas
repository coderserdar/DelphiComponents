...
const
  ...
  FieldTypeMap: TFieldMap = (
    ...
    , fldBLOB, fldBLOB, fldUNKNOWN, fldUNKNOWN, fldUNKNOWN, fldZSTRING, fldTIMESTAMP, fldBCD
    );
...
const
  VarTypeMap: array[TFieldType] of Integer = (varError, varOleStr, varSmallint,
    ...
    ,varOleStr, varOleStr, varVariant, varUnknown, varDispatch, varOleStr, varDate, varCurrency
    );
var
  vType: Integer;
begin
