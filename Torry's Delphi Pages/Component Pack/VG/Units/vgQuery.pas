...
function TvgUpdateScript.GetDataSet: TDataSet;
begin
  Result := FDataSet;
end;

procedure TvgUpdateScript.SetDataSet(ADataSet: TDataSet);
var
  OldDataSet: TBDEDataSet;
begin
  if (FDataSet <> ADataSet) then
  begin
    OldDataSet := FDataSet as TBDEDataSet;
    FDataSet := ADataSet as TBDEDataSet;
