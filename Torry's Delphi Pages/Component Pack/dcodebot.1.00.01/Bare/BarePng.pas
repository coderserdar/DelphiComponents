...
uses
 Windows {$IFDEF UseDelphi}, Classes, Graphics, SysUtils{$ENDIF}, BareUtils
 {$IFDEF Debug}, Dialogs{$ENDIF}, pngzlib, pnglang;
...
type
  ...
  TPngImage = class({$IFDEF UseDelphi}TGraphic{$ELSE}TPersistent{$ENDIF})
  protected
    {Gamma table values}
...
procedure TPngImage.SetMaxIdatSize(const Value: Cardinal);
begin
