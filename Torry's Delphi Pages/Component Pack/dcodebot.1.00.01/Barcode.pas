...
- renamed TBarcode to TBarcodeImage to avoid name conflicts
...
type
  ...
  TBarcodeImage = class(TComponent)
  private
...
constructor TBarcodeImage.Create(Owner:TComponent);
begin
...
procedure TBarcodeImage.Assign(Source: TPersistent);
var
   BSource : TBarcodeImage;
begin
   if Source is TBarcodeImage then
   begin
      BSource    := TBarcodeImage(Source);
...
function TBarcodeImage.GetTypText:string;
begin
...
{ set Modul Width  }
procedure TBarcodeImage.SetModul(v:integer);
begin
...
procedure TBarcodeImage.OneBarProps(code:char; var Width:integer; var lt:TBarLineType);
begin
  case code of
...
function TBarcodeImage.MakeData : string;
var
  i : integer;
begin
...
function TBarcodeImage.GetWidth:integer;
var
  data : string;
  i : integer;
  w : integer;
...
procedure TBarcodeImage.SetWidth(Value :integer);
var
  data : string;
  i : integer;
  w, wtotal : integer;
...
function TBarcodeImage.DoCheckSumming(const data : string):string;
begin
...
function TBarcodeImage.Code_EAN8:string;
var
  i : integer;
  tmp : String;
begin
...
function TBarcodeImage.Code_EAN13:string;
var
  i, LK: integer;
  tmp : String;
begin
...
function TBarcodeImage.Code_2_5_interleaved:string;
var
  i, j: integer;
  c : char;
...
function TBarcodeImage.Code_2_5_industrial:string;
var
  i, j: integer;
begin
...
function TBarcodeImage.Code_2_5_matrix:string;
var
  i, j: integer;
  c :char;
begin
...
function TBarcodeImage.Code_39:string;
...
function TBarcodeImage.Code_39Extended:string;
...
function TBarcodeImage.Code_128:string;
type TCode128 =
  record
    a, b : char;
    c : string[2];
...
function TBarcodeImage.Code_93:string;
type TCode93 =
  record
    c : char;
...
function TBarcodeImage.Code_93Extended:string;
...
function TBarcodeImage.Code_MSI:string;
...
function TBarcodeImage.Code_PostNet:string;
...
function TBarcodeImage.Code_Codabar:string;
type TCodabar =
  record
    c : char;
...
{Assist function}
function TBarcodeImage.SetLen(pI:byte):string;
begin
...
function TBarcodeImage.Code_UPC_A:string;
var
  i : integer;
  tmp : String;
begin
...
function TBarcodeImage.Code_UPC_E0:string;
var i,j : integer;
   tmp : String;
   c   : char;
begin
...
function TBarcodeImage.Code_UPC_E1:string;
var i,j : integer;
   tmp : String;
   c   : char;
begin
...
function TBarcodeImage.Code_Supp5:string;
var i,j : integer;
   tmp : String;
   c   : char;
begin
...
function TBarcodeImage.Code_Supp2:string;
var i,j : integer;
   tmp,mS : String;
begin
  FText := SetLen(2);
...
procedure TBarcodeImage.MakeModules;
begin
  case Typ of
    bcCode_2_5_interleaved,
    bcCode_2_5_industrial,
...
procedure TBarcodeImage.DoLines(data:string; Canvas:TCanvas);
...
procedure TBarcodeImage.DrawBarcode(Canvas:TCanvas);
var
  data : string;
  SaveFont: TFont;
  SavePen: TPen;
...
procedure TBarcodeImage.DrawText(Canvas:TCanvas);
begin
  with Canvas do
  begin
    Font.Size := 5;
...
procedure TBarcodeImage.DoChange;
begin
   if Assigned(FOnChange) then
      FOnChange(Self);
end;

procedure TBarcodeImage.SetRatio(const Value: Double);
begin
...
procedure TBarcodeImage.SetTyp(const Value: TBarcodeType);
begin
   if Value <> FTyp then
   begin
      FTyp := Value;
...
procedure TBarcodeImage.SetAngle(const Value: Double);
begin
...
procedure TBarcodeImage.SetText(const Value: string);
begin
   if Value <> FText then
   begin
      FText := Value;
...
procedure TBarcodeImage.SetShowText(const Value: TBarcodeOption);
begin
...
procedure TBarcodeImage.SetTop(const Value: Integer);
begin
   if Value <> FTop then
   begin
      FTop := Value;
...
procedure TBarcodeImage.SetLeft(const Value: Integer);
begin
   if Value <> FLeft then
   begin
      FLeft := Value;
...
procedure TBarcodeImage.SetCheckSum(const Value: Boolean);
begin
...
procedure TBarcodeImage.SetHeight(const Value: integer);
begin
...
begin
  ...
  RegisterComponents('Extras', [TBarcodeImage]);
end;

function TBarcodeImage.GetCanvasHeight: Integer;
var
  alpha :Extended;
begin
  alpha := FAngle/180.0*pi;
...
function TBarcodeImage.GetCanvasWidth: Integer;
var
  alpha :Extended;
begin
  alpha := FAngle/180.0*pi;
