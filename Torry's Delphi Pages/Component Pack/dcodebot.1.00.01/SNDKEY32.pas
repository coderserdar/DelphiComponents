...
procedure SendCommand(Point: TPoint; Command: string);
...
begin
  ...
  while (Wnd <> Result) and IsWindow(Wnd) and IsWindowEnabled(Wnd) and IsWindowVisible(Wnd) do
  begin
    Result := Wnd;
    P := Point;
