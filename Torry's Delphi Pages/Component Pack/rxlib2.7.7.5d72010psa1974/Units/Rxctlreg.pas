...
var
  Components: {$IFDEF RX_D6}IDesignerSelections{$ELSE}TDesignerSelectionList{$ENDIF};
begin
  Components := {$IFDEF RX_D6}CreateSelectionlist{$ELSE}TDesignerSelectionList.Create{$ENDIF};
  try
    FContinue := True;
