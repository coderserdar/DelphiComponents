...
uses
  ...
  SpTBXControls, SpTBXEditors, SpTBXExtEditors, SpTBXCustomizer, SpTBXMDIMRU;
...
begin
  ...
  RegisterComponents('SpTBXLib', [TSpTBXDock, TSpTBXMultiDock, TSpTBXToolbar,
    ...
    TSpTBXComboBox, TSpTBXFontComboBox, TSpTBXListBox, TSpTBXCheckListBox, TSpTBXCustomizer]);
