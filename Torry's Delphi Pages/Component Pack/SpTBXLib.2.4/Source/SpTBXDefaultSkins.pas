...
begin
  ...
  CopyOptions(skncToolbarItem, skncListItem);
...
begin
  ...
  CopyOptions(skncMenuBarItem, skncListItem);
...
begin
  ...
  CopyOptions(skncButton, skncListItem);
...
begin
  ...
  CopyOptions(skncButton, skncListItem);
  Options(skncListItem, sknsChecked).Body.Fill(5, clWhite, $DADADA, $D0D0D0, $E0E0E0);
...
begin
  ...
  //---- Elements ----//
  Options(skncGutter, sknsNormal).Body.Fill(0, $EFEFEF, clNone, clNone, clNone);
  ...
  Options(skncToolbarItem, sknsHotTrack).Borders.Fill(1, $7E99A9, $7E99A9, $D2FBFF, $D2FBFF);
  Options(skncToolbarItem, sknsPushed).Body.Fill(7, $70BAFC, $59A5F3, $388FEF, $64CDFD);
  Options(skncToolbarItem, sknsPushed).Borders.Fill(1, $65818E, $AEBDC3, $34CFFF, $34CFFF);
  Options(skncToolbarItem, sknsChecked).Body.Fill(7, $A8D6FE, $61AFFC, $329BFB, $ACF0FF);
  Options(skncToolbarItem, sknsChecked).Borders.Fill(1, $65818E, $AEBDC3, $34CFFF, $34CFFF);
  Options(skncToolbarItem, sknsCheckedAndHotTrack).Body.Fill(7, $70BAFC, $59A5F3, $388FEF, $64CDFD);
  Options(skncToolbarItem, sknsCheckedAndHotTrack).Borders.Fill(1, $65818E, $AEBDC3, $34CFFF, $34CFFF);
