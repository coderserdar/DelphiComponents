...
begin
  if Index = 0 then begin
    // Draw the separator
    SpDrawXPText(TTntListBox(Control).Canvas, SSpTBXCustomizerFormSeparator, Rect, DT_SINGLELINE or DT_CENTER or DT_VCENTER);
  end
  else
    if (Index = 1) and Customizer.BlankSeparators then begin
      // Draw the blank separator
      SpDrawXPText(TTntListBox(Control).Canvas, SSpTBXCustomizerFormBlankSeparator, Rect, DT_SINGLELINE or DT_CENTER or DT_VCENTER);
    end
    else
