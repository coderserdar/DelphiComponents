...
//
// $Id: TBXToolPals.pas 99 2005-09-23 19:34:50Z Alex $
...
var
  ...
  R: TRect;
begin
  CurrentTheme.PaintButton(Canvas.Handle, CellRect, ItemInfo);
...
begin
  ...
  begin
    ...
    if (ImgList <> nil) and (ImgIndex >= 0) and (ImgIndex < ImgList.Count) then
      CurrentTheme.PaintImage(Canvas.Handle, ARect, ItemInfo, ImgList, ImgIndex);
  end;
...
begin
  ...
  begin
    R := ClientAreaRect;
    CurrentTheme.PaintMenuItemFrame(Canvas.Handle, R, ItemInfo);
  end;
