...
//
// $Id: TBXThemes.pas 99 2005-09-23 19:34:50Z Alex $
...
uses
  Windows, Messages, Classes, Forms, Graphics, ImgList, CommCtrl;
...
const
  ...
  VT_BARS                    = $0100;
  VT_NORMALTOOLBAR           = VT_BARS or 1;
  VT_MENUBAR                 = VT_BARS or 2;

  VT_POPUPS                  = $0200;
  VT_POPUPMENU               = VT_POPUPS or 1;
  VT_LISTBOX                 = VT_POPUPS or 2;
  VT_TOOLBOX                 = VT_POPUPS or 3;
  VT_CHEVRONMENU             = VT_POPUPS or 4;
  ...
  VT_DOCK                    = $0600;
  VT_BARDOCK                 = VT_DOCK or 1;
  VT_MULTIDOCK               = VT_DOCK or 2;

  VT_TYPEMASK                = $FFFF;
  VT_CATEGORYMASK            = $FF00;

  { Toolbar/Dockable panel view types }
  VT_FLOATING                = $10000;
  VT_RESIZABLE               = $20000;  // valid only when floating
  VT_EMBEDDED                = $40000;  // when the toolbar is not floating or docked
...
const
  ...
  IO_RADIO                   = $10;
  IO_DESIGNING               = $20;
  IO_APPACTIVE               = $40;  // True when Application.Active = True
...
type
  ...
  public
    ...
    { Margins, color, etc. }
    function  GetImageOffset(DC: HDC; const ItemInfo: TTBXItemInfo; ImageList: TCustomImageList): TPoint; virtual; abstract;
    ...
    procedure PaintBackgnd(DC: HDC; const ADockRect, ARect, AClipRect: TRect; AColor: TColor; AViewType: Integer); virtual; abstract;
    procedure PaintButton(DC: HDC; const ARect: TRect; const ItemInfo: TTBXItemInfo); virtual; abstract;
    procedure PaintCaption(DC: HDC; const Rect: TRect; const ItemInfo: TTBXItemInfo; const Caption: WideString; Format: Cardinal; Color: TColor = clDefault); virtual; abstract;
    procedure PaintCheckMark(DC: HDC; ARect: TRect; const ItemInfo: TTBXItemInfo); virtual; abstract;
    procedure PaintChevron(DC: HDC; ARect: TRect; const ItemInfo: TTBXItemInfo); virtual; abstract;
    procedure PaintEditFrame(DC: HDC; const ARect: TRect; var ItemInfo: TTBXItemInfo; const EditInfo: TTBXEditInfo); virtual; abstract;
    procedure PaintEditButton(DC: HDC; const ARect: TRect; var ItemInfo: TTBXItemInfo; ButtonInfo: TTBXEditBtnInfo); virtual; abstract;
    procedure PaintDock(DC: HDC; const ClientRect, DockRect: TRect; DockPosition: Integer); virtual; abstract;
    procedure PaintDockPanelNCArea(DC: HDC; R: TRect; const DockPanelInfo: TTBXDockPanelInfo); virtual; abstract;
    procedure PaintDropDownArrow(DC: HDC; const ARect: TRect; const ItemInfo: TTBXItemInfo); virtual; abstract;
    procedure PaintFloatingBorder(DC: HDC; const ARect: TRect; const WindowInfo: TTBXWindowInfo); virtual; abstract;
    procedure PaintFrame(DC: HDC; const ARect: TRect; const ItemInfo: TTBXItemInfo); virtual; abstract;
    procedure PaintImage(DC: HDC; ARect: TRect; const ItemInfo: TTBXItemInfo; ImageList: TCustomImageList; ImageIndex: Integer); virtual; abstract;
    procedure PaintMDIButton(DC: HDC; ARect: TRect; const ItemInfo: TTBXItemInfo; ButtonKind: Cardinal); virtual; abstract;
    procedure PaintMenuItem(DC: HDC; const ARect: TRect; var ItemInfo: TTBXItemInfo); virtual; abstract;
    procedure PaintMenuItemFrame(DC: HDC; const ARect: TRect; const ItemInfo: TTBXItemInfo); virtual; abstract;
    procedure PaintPageScrollButton(DC: HDC; const ARect: TRect; ButtonType: Integer; Hot: Boolean); virtual; abstract;
    procedure PaintPopupNCArea(DC: HDC; R: TRect; const PopupInfo: TTBXPopupInfo); virtual; abstract;
    procedure PaintSeparator(DC: HDC; ARect: TRect; ItemInfo: TTBXItemInfo; Horizontal, LineSeparator: Boolean); virtual; abstract;
    procedure PaintToolbarNCArea(DC: HDC; R: TRect; const WindowInfo: TTBXToolbarInfo); virtual; abstract;
    procedure PaintFrameControl(DC: HDC; R: TRect; Kind, State: Integer; Params: Pointer); virtual; abstract;
    procedure PaintStatusBar(DC: HDC; R: TRect; Part: Integer); virtual; abstract;
