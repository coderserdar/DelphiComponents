...
{$IFDEF Delphi16}
procedure CompressBuf(CompressionLevel: TCompressionLevel; const InBuf: Pointer; InBytes: Integer;
...
begin
  ...
  try
    ...
    CCheck(deflateInit_(@strm, Levels[CompressionLevel], zlib_version, sizeof(strm)));
    try
