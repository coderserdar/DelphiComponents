      ...
      With tblSource Do
        Begin
          ...
          For I := 0 To Pred(lstBDETables.Items.Count) Do
            If lstBDETables.Selected[I] Then
              Begin
...
Begin
  ...
  { Check Requirements }
  If (lstBDETables.SelCount = 0) Then
    Begin
  ...
  If (lstBDETables.SelCount = 1) And (edTfsTableName.Text = '') Then
    Begin
  ...
  For Inx := 0 To Pred(lstBDETables.Items.Count) Do
    Begin
      If lstBDETables.Selected[Inx] Then
        Begin
          If lstBDETables.SelCount > 1 Then
  ...
  If (lstBDETables.SelCount = 1) Then
    Begin
      For Inx := 0 To Pred(lstBDETables.Items.Count) Do
        If lstBDETables.Selected[Inx] Then
          Begin
            edTfsTableName.Text := ChangeFileExt(lstBDETables.Items[Inx], '');
            Break;
          End;
    End;
End;
