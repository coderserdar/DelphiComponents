    ...
    Begin
      If (gdParams.Cells[colParamValue, RowIdx] <> '') Or
        ...
        Begin
          ...
          If Uppercase(gdParams.Cells[colParamValue, RowIdx]) = 'NULL' Then
            Begin
              aParams[RowIdx - 1].Value := null;
            End
          Else
...
Begin
  ...
  For RowIdx := 1 To Pred(gdParams.RowCount) Do
    Begin
      ...
      If VarIsNull(aParams[RowIdx - 1].Value ) Then
        gdParams.Cells[colParamValue, RowIdx] := 'NULL'
      Else
