...
Type
  TdlgTableProcedures = Class(TForm)
    ...
    Procedure Fontgrid1Click(Sender: TObject); {!!.07}
  Private
...
Var
  dlgTableProcedures: TdlgTableProcedures;
...
Procedure TdlgTableProcedures.GetData(Var f, f1: String; SepL, SepR: String);
Var
  i, j: Integer;
  s1, s2: String;
Begin
...
Procedure TdlgTableProcedures.FormCreate(Sender: TObject);
Begin
...
Procedure TdlgTableProcedures.SetReadOnly(Const Value: Boolean);
Var
  i: Integer;
  bm: Db.TBookmark;
  FieldsTags: TList;
...
Procedure TdlgTableProcedures.FormShow(Sender: TObject);
Var
  aServerName: String;
  aAddress: String;
  I: Integer;
...
Begin
  ...
  Try
    ...
    For I := 0 To FTable1.Dictionary.FieldCount - 1 Do
      If FTable1.Dictionary.FieldName[i] <> 'BLR' Then
        Begin
...
Procedure TdlgTableProcedures.cboIndexChange(Sender: TObject);
Var
  BaseSection: String;
  Index: Integer;
Begin
...
Procedure TdlgTableProcedures.mnuTableCloseClick(Sender: TObject);
Begin
  Close;
End;
{--------}

Procedure TdlgTableProcedures.FormClose(Sender: TObject; Var Action: TCloseAction);
Begin
  Action := caFree;
End;
{--------}

Procedure TdlgTableProcedures.mnuViewRefreshClick(Sender: TObject);
Begin
  FTable1.Refresh;
  UpdateDisplay;
End;
...
Procedure TdlgTableProcedures.UpdateDisplay;
Begin
...
Procedure TdlgTableProcedures.mnuViewShowFilterClick(Sender: TObject);
Begin
End;
{--------}

Procedure TdlgTableProcedures.FormDestroy(Sender: TObject);
Begin
  {Begin !!.05 !!.10}
  Try
    FTable1.Close;
...
Procedure TdlgTableProcedures.CloseDuringShow(Var Message: TMessage);
Begin
  Close;
End;
{--------}
...
Procedure TdlgTableProcedures.mnuViewShowRecordCountClick(Sender: TObject);
Begin
  mnuViewShowRecordCount.Checked := Not mnuViewShowRecordCount.Checked;
  UpdateDisplay;
End;

Procedure TdlgTableProcedures.grdTableBrowserKeyDown(Sender: TObject; Var Key: Word;
  Shift: TShiftState);
Var
  DoPost: Boolean; {!!.11}
Begin
...
Procedure TdlgTableProcedures.mnuOptionsDebugClick(Sender: TObject);
Begin
End;
{End !!.02}
...
Procedure TdlgTableProcedures.FTableAfterPost(DataSet: TDataSet);
Begin
...
Procedure TdlgTableProcedures.FTableAfterCancel(DataSet: TDataSet);
Begin
  If FTable1.Database.InTransaction Then
...
Procedure TdlgTableProcedures.FTableAfterScroll(DataSet: TDataSet);
Begin
  ViewActiveBlobField;
End;
{--------}

Procedure TdlgTableProcedures.FTableBeforeEdit(DataSet: TDataSet);
Begin
...
Procedure TdlgTableProcedures.FTableBeforeInsert(DataSet: TDataSet);
Begin
  If Not FTable1.Database.InTransaction Then
    FTable1.Database.StartTransaction;
End;
...
Procedure TdlgTableProcedures.mnuOptionsTimeoutClick(Sender: TObject);
Var
  sTimeout: String;
  res: Boolean;
Begin
...
Procedure TdlgTableProcedures.FormKeyDown(Sender: TObject; Var Key: Word;
  Shift: TShiftState);
Begin
...
Procedure TdlgTableProcedures.ViewActiveBlobField;
Const
...
Function TdlgTableProcedures.HasBlobOrByteArrayField: Boolean;
Var
  i: Integer;
Begin
  Result := False;
...
Procedure TdlgTableProcedures.cbStretchClick(Sender: TObject);
Var
  i: Integer;
Begin
...
Procedure TdlgTableProcedures.btnClearBAClick(Sender: TObject);
Var
  fieldIdx,
    controlIdx: Integer;
  aEdit: TMaskEdit;
...
Procedure TdlgTableProcedures.pcBlobfieldsChange(Sender: TObject);
Begin
  ViewActiveBlobField;
End;
{--------}

Procedure TdlgTableProcedures.mnuViewShowBLOBFieldsClick(Sender: TObject);
Begin
...
Procedure TdlgTableProcedures.btnLoadMemoClick(Sender: TObject);
Var
  fieldIdx,
    controlIdx: Integer;
  adbMemo: TdbMemo;
...
Procedure TdlgTableProcedures.btnSaveMemoClick(Sender: TObject);
Var
  fieldIdx,
    controlIdx: Integer;
  adbMemo: TdbMemo;
...
Procedure TdlgTableProcedures.btnLoadGenericClick(Sender: TObject);
Var
  fieldIdx,
    controlIdx: Integer;
  aMemo: TMemo;
...
Procedure TdlgTableProcedures.btnSaveGenericClick(Sender: TObject);
Var
  fieldIdx,
    controlIdx: Integer;
  aMemo: TMemo;
...
Procedure TdlgTableProcedures.btnClearMemoClick(Sender: TObject);
Var
  fieldIdx,
    controlIdx: Integer;
  adbMemo: TdbMemo;
...
Procedure TdlgTableProcedures.btnLoadGraphicClick(Sender: TObject);
Var
  fieldIdx,
    controlIdx: Integer;
  aImage: TDbImage;
...
Procedure TdlgTableProcedures.btnSaveGraphicClick(Sender: TObject);
Var
  fieldIdx,
    controlIdx: Integer;
  aImage: TImage;
...
Procedure TdlgTableProcedures.btnClearGraphicClick(Sender: TObject);
Var
  fieldIdx,
    controlIdx: Integer;
  aImage: TDbImage;
...
Procedure TdlgTableProcedures.btnClearGenericClick(Sender: TObject);
Var
  fieldIdx,
    controlIdx: Integer;
  aMemo: TMemo;
...
Procedure TdlgTableProcedures.meByteArrayKeyPress(Sender: TObject; Var Key: Char);
Begin
...
Procedure TdlgTableProcedures.mnuTableDesignReportClick(Sender: TObject);
Begin
End;

{ magic resize numbers: 100 = width of buttons + 8 pixels of space on each side }

Procedure TdlgTableProcedures.tsMemoTemplateResize(Sender: TObject);
Var
  controlIdx: Integer;
Begin
...
Procedure TdlgTableProcedures.tsGraphicTemplateResize(Sender: TObject);
Var
  controlIdx: Integer;
Begin
  For controlIdx := 0 To TTabSheet(Sender).ControlCount - 1 Do
...
Procedure TdlgTableProcedures.tsGenericBlobTemplateResize(Sender: TObject);
Var
  controlIdx: Integer;
Begin
  For controlIdx := 0 To TTabSheet(Sender).ControlCount - 1 Do
...
Procedure TdlgTableProcedures.tsByteArrayTemplateResize(Sender: TObject);
Var
  controlIdx: Integer;
Begin
  For controlIdx := 0 To TTabSheet(Sender).ControlCount - 1 Do
...
Procedure TdlgTableProcedures.meByteArrayChange(Sender: TObject);
Var
  ByteArrayBuffer: Pointer;
  fieldIdx,
    controlIdx: Integer;
...
Procedure TdlgTableProcedures.cbWordwrapClick(Sender: TObject);
Var
  i: Integer;
Begin
  For i := 0 To TCheckBox(Sender).Parent.ControlCount - 1 Do
...
Procedure TdlgTableProcedures.mnuTableCopyToTableClick(Sender: TObject);
Var
  ExcludeIndex,
...
Procedure TdlgTableProcedures.mnuTableDeleteRecordsClick(Sender: TObject);
Begin
...
Procedure TdlgTableProcedures.UpdateDefaultTimeout;
Begin
  FClient.TimeOut := Config.DefaultTimeout; {!!.11}
End;

Procedure TdlgTableProcedures.Fontgrid1Click(Sender: TObject);
Begin
