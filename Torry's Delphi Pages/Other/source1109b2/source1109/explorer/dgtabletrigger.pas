...
Var
  dlgTableTrigger: TdlgTableTrigger;
...
Procedure TdlgTableTrigger.GetData(Var f, f1: String; SepL, SepR: String);
Var
  i, j: Integer;
  s1, s2: String;
Begin
...
Procedure TdlgTableTrigger.FormCreate(Sender: TObject);
Begin
...
Procedure TdlgTableTrigger.SetReadOnly(Const Value: Boolean);
Var
  i: Integer;
  bm: Db.TBookmark;
  FieldsTags: TList;
...
Procedure TdlgTableTrigger.FormShow(Sender: TObject);
Var
  aServerName: String;
  aAddress: String;
  I: Integer;
...
Procedure TdlgTableTrigger.cboIndexChange(Sender: TObject);
Var
  BaseSection: String;
  Index: Integer;
Begin
...
Procedure TdlgTableTrigger.mnuTableCloseClick(Sender: TObject);
Begin
  Close;
End;
{--------}

Procedure TdlgTableTrigger.FormClose(Sender: TObject; Var Action: TCloseAction);
Begin
  Action := caFree;
End;
{--------}

Procedure TdlgTableTrigger.mnuViewRefreshClick(Sender: TObject);
Begin
  FTable1.Refresh;
  UpdateDisplay;
End;
...
Procedure TdlgTableTrigger.UpdateDisplay;
Begin
...
Procedure TdlgTableTrigger.mnuViewShowFilterClick(Sender: TObject);
Begin
End;
{--------}

Procedure TdlgTableTrigger.FormDestroy(Sender: TObject);
Begin
  {Begin !!.05 !!.10}
  Try
    FTable1.Close;
...
Procedure TdlgTableTrigger.CloseDuringShow(Var Message: TMessage);
Begin
  Close;
End;
{--------}
...
Procedure TdlgTableTrigger.mnuViewShowRecordCountClick(Sender: TObject);
Begin
  mnuViewShowRecordCount.Checked := Not mnuViewShowRecordCount.Checked;
  UpdateDisplay;
End;

Procedure TdlgTableTrigger.grdTableBrowserKeyDown(Sender: TObject; Var Key: Word;
  Shift: TShiftState);
Var
  DoPost: Boolean; {!!.11}
Begin
...
Procedure TdlgTableTrigger.mnuOptionsDebugClick(Sender: TObject);
Begin
End;
{End !!.02}
...
Procedure TdlgTableTrigger.FTableAfterPost(DataSet: TDataSet);
Begin
...
Procedure TdlgTableTrigger.FTableAfterCancel(DataSet: TDataSet);
Begin
  If FTable1.Database.InTransaction Then
...
Procedure TdlgTableTrigger.FTableAfterScroll(DataSet: TDataSet);
Begin
  ViewActiveBlobField;
End;
{--------}

Procedure TdlgTableTrigger.FTableBeforeEdit(DataSet: TDataSet);
Begin
...
Procedure TdlgTableTrigger.FTableBeforeInsert(DataSet: TDataSet);
Begin
  If Not FTable1.Database.InTransaction Then
    FTable1.Database.StartTransaction;
End;
...
Procedure TdlgTableTrigger.mnuOptionsTimeoutClick(Sender: TObject);
Var
  sTimeout: String;
  res: Boolean;
Begin
...
Procedure TdlgTableTrigger.FormKeyDown(Sender: TObject; Var Key: Word;
  Shift: TShiftState);
Begin
...
Procedure TdlgTableTrigger.ViewActiveBlobField;
Const
...
Function TdlgTableTrigger.HasBlobOrByteArrayField: Boolean;
Var
  i: Integer;
Begin
  Result := False;
...
Procedure TdlgTableTrigger.cbStretchClick(Sender: TObject);
Var
  i: Integer;
Begin
...
Procedure TdlgTableTrigger.btnClearBAClick(Sender: TObject);
Var
  fieldIdx,
    controlIdx: Integer;
  aEdit: TMaskEdit;
...
Procedure TdlgTableTrigger.pcBlobfieldsChange(Sender: TObject);
Begin
  ViewActiveBlobField;
End;
{--------}

Procedure TdlgTableTrigger.mnuViewShowBLOBFieldsClick(Sender: TObject);
Begin
...
Procedure TdlgTableTrigger.btnLoadMemoClick(Sender: TObject);
Var
  fieldIdx,
    controlIdx: Integer;
  adbMemo: TdbMemo;
...
Procedure TdlgTableTrigger.btnSaveMemoClick(Sender: TObject);
Var
  fieldIdx,
    controlIdx: Integer;
  adbMemo: TdbMemo;
...
Procedure TdlgTableTrigger.btnLoadGenericClick(Sender: TObject);
Var
  fieldIdx,
    controlIdx: Integer;
  aMemo: TMemo;
...
Procedure TdlgTableTrigger.btnSaveGenericClick(Sender: TObject);
Var
  fieldIdx,
    controlIdx: Integer;
  aMemo: TMemo;
...
Procedure TdlgTableTrigger.btnClearMemoClick(Sender: TObject);
Var
  fieldIdx,
    controlIdx: Integer;
  adbMemo: TdbMemo;
...
Procedure TdlgTableTrigger.btnLoadGraphicClick(Sender: TObject);
Var
  fieldIdx,
    controlIdx: Integer;
  aImage: TDbImage;
...
Procedure TdlgTableTrigger.btnSaveGraphicClick(Sender: TObject);
Var
  fieldIdx,
    controlIdx: Integer;
  aImage: TImage;
...
Procedure TdlgTableTrigger.btnClearGraphicClick(Sender: TObject);
Var
  fieldIdx,
    controlIdx: Integer;
  aImage: TDbImage;
...
Procedure TdlgTableTrigger.btnClearGenericClick(Sender: TObject);
Var
  fieldIdx,
    controlIdx: Integer;
  aMemo: TMemo;
...
Procedure TdlgTableTrigger.meByteArrayKeyPress(Sender: TObject; Var Key: Char);
Begin
...
Procedure TdlgTableTrigger.mnuTableDesignReportClick(Sender: TObject);
Begin
End;

{ magic resize numbers: 100 = width of buttons + 8 pixels of space on each side }

Procedure TdlgTableTrigger.tsMemoTemplateResize(Sender: TObject);
Var
  controlIdx: Integer;
Begin
...
Procedure TdlgTableTrigger.tsGraphicTemplateResize(Sender: TObject);
Var
  controlIdx: Integer;
Begin
  For controlIdx := 0 To TTabSheet(Sender).ControlCount - 1 Do
...
Procedure TdlgTableTrigger.tsGenericBlobTemplateResize(Sender: TObject);
Var
  controlIdx: Integer;
Begin
  For controlIdx := 0 To TTabSheet(Sender).ControlCount - 1 Do
...
Procedure TdlgTableTrigger.tsByteArrayTemplateResize(Sender: TObject);
Var
  controlIdx: Integer;
Begin
  For controlIdx := 0 To TTabSheet(Sender).ControlCount - 1 Do
...
Procedure TdlgTableTrigger.meByteArrayChange(Sender: TObject);
Var
  ByteArrayBuffer: Pointer;
  fieldIdx,
    controlIdx: Integer;
...
Procedure TdlgTableTrigger.cbWordwrapClick(Sender: TObject);
Var
  i: Integer;
Begin
  For i := 0 To TCheckBox(Sender).Parent.ControlCount - 1 Do
...
Procedure TdlgTableTrigger.mnuTableCopyToTableClick(Sender: TObject);
Var
  ExcludeIndex,
...
Procedure TdlgTableTrigger.mnuTableDeleteRecordsClick(Sender: TObject);
Begin
...
Procedure TdlgTableTrigger.UpdateDefaultTimeout;
Begin
  FClient.TimeOut := Config.DefaultTimeout; {!!.11}
End;

Procedure TdlgTableTrigger.Fontgrid1Click(Sender: TObject);
Begin
