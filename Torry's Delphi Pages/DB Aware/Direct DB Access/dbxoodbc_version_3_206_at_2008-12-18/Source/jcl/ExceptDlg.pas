...
uses
  ...
  StdCtrls, ExtCtrls, {AppEvnts,} JclDebug, JclSysUtils;
...
begin
  ...
  //   Error reading TextLabel.Lines.Strings: Win32 Error.  Code: 2.
  //   Error reading TextLabel.Lines.Strings: A Win32 API function failed.
