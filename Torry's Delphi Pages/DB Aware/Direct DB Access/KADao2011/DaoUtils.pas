...
Begin
 ...
 Case DaoType of
        ...
        dbText           : Result := ftWideString;
        dbLongBinary     : Result := ftBlob;                                
        dbMemo           : Result := ftWideMemo;
        //********************************************
...
Begin
 ...
 Case BDEType of
        ...
        ftIDispatch    : Result := dbUnspecifyed;
      End;
End;
...
Begin
 ...
 Case DaoType of
        ...
        dbAttachment     : Result := 'dbAttachment';
        dbComplexByte    : Result := 'dbComplexByte';
        dbComplexInteger : Result := 'dbComplexInteger';
        dbComplexLong    : Result := 'dbComplexLong';
        dbComplexSingle  : Result := 'dbComplexSingle';
        dbComplexDouble  : Result := 'dbComplexDouble';
        dbComplexDecimal : Result := 'dbComplexDecimal';
        dbComplexGUID    : Result := 'dbComplexGUID';
        dbComplexText    : Result := 'dbComplexText';
 End;
End;
