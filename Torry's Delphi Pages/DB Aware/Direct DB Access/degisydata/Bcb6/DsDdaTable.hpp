...
// (DO NOT EDIT: machine generated header) 'DsDdaTable.pas' rev: 6.00

#ifndef DsDdaTableHPP
#define DsDdaTableHPP
...
#include <DsDdaApi.hpp>	// Pascal unit
...
namespace Dsddatable
{
//-- type declarations -------------------------------------------------------
class DELPHICLASS TDsDdaTable;
class PASCALIMPLEMENTATION TDsDdaTable : public Db::TDataSet 
{
	typedef Db::TDataSet inherited;
	
private:
	Dsddaapi::TDdaHandle* FHandle;
...
protected:
	Dsddaapi::TDdaHandle* __fastcall CreateHandle(void);
	...
	void __fastcall AddField(Dsddaapi::TDdaField* Fld, int FieldID, Db::TFieldDefs* FieldDefs);
...
public:
	__fastcall virtual TDsDdaTable(Classes::TComponent* AOwner);
	__fastcall virtual ~TDsDdaTable(void);
	...
	__property Dsddaapi::TDdaHandle* Handle = {read=FHandle};
