...
// (DO NOT EDIT: machine generated header) 'DsPdxTable.pas' rev: 6.00

#ifndef DsPdxTableHPP
#define DsPdxTableHPP
...
#include <DsPdxApi.hpp>	// Pascal unit
...
namespace Dspdxtable
{
//-- type declarations -------------------------------------------------------
class DELPHICLASS TDsPdxTable;
class PASCALIMPLEMENTATION TDsPdxTable : public Db::TDataSet 
{
	typedef Db::TDataSet inherited;
	
private:
	Dspdxapi::TPdxHandle* FHandle;
	...
	void __fastcall SetAutoCodePage(const bool Value);
	
protected:
	Dspdxapi::TPdxHandle* __fastcall CreateHandle(void);
	...
	void __fastcall AddField(Dspdxapi::TPdxField* Fld, int FieldID, Db::TFieldDefs* FieldDefs);
...
public:
	__fastcall virtual TDsPdxTable(Classes::TComponent* AOwner);
	__fastcall virtual ~TDsPdxTable(void);
	...
	__property Dspdxapi::TPdxHandle* Handle = {read=FHandle};
...
__published:
	...
	__property bool AutoCodePage = {read=FAutoCodePage, write=SetAutoCodePage, default=1};
