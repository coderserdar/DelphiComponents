...
// (DO NOT EDIT: machine generated header) 'DsClrTable.pas' rev: 6.00

#ifndef DsClrTableHPP
#define DsClrTableHPP
...
#include <DsClrApi.hpp>	// Pascal unit
...
namespace Dsclrtable
{
//-- type declarations -------------------------------------------------------
class DELPHICLASS TDsClrTable;
class PASCALIMPLEMENTATION TDsClrTable : public Db::TDataSet 
{
	typedef Db::TDataSet inherited;
	
private:
	Dsclrapi::TClrHandle* FHandle;
	...
	void __fastcall SetDecodeDate(const bool Value);
	void __fastcall SetDecodeTime(const bool Value);
	
protected:
	Dsclrapi::TClrHandle* __fastcall CreateHandle(void);
	...
	void __fastcall AddField(Dsclrapi::TClrField* Fld, int FieldID, Db::TFieldDefs* FieldDefs);
...
public:
	__fastcall virtual TDsClrTable(Classes::TComponent* AOwner);
	__fastcall virtual ~TDsClrTable(void);
	...
	Dsdbapi::DsRecStatus __fastcall GetRecStatus(void);
	void __fastcall SetRecStatus(Dsdbapi::DsRecStatus Status);
	...
	__property Dsclrapi::TClrHandle* Handle = {read=FHandle};
...
__published:
	...
	__property bool DecodeDate = {read=FDecodeDate, write=SetDecodeDate, default=0};
	__property bool DecodeTime = {read=FDecodeTime, write=SetDecodeTime, default=0};
...
//-- var, const, procedure ---------------------------------------------------
extern PACKAGE void __fastcall DsGetTableNames(Dsdatabase::TDsDatabase* Db, bool Extensions, Classes::TStrings* List);

}	/* namespace Dsclrtable */
using namespace Dsclrtable;
#pragma option pop	// -w-
