 ...
 * bit 15 off:  lparam is just a UNLongint data type.
 *
...
//#if(WINVER >= 0x040A)
  ...
  DBT_DEVTYP_THandle            = $00000006; // file system handle
  {$EXTERNALSYM DBT_DEVTYP_THandle}
//#endif /* WINVER >= 0x040A */
...
//#if(WINVER >= 0x0501)
//
// Define 32-bit and 64-bit versions of the DEV_BROADCAST_THandle structure
// for WOW64.  These must be kept in sync with the above structure.
//

  PDevBroadcastHandle32 = ^TDevBroadcastHandle32;
  {$EXTERNALSYM _DEV_BROADCAST_HANDLE32}
  _DEV_BROADCAST_HANDLE32 = record
    dbch_size       : DWORD;
    dbch_devicetype : DWORD;
    dbch_reserved   : DWORD;
    dbch_handle     : Longword;
    dbch_hdevnotify : Longword;
    dbch_eventguid  : TGUID;
  ...
  TDevBroadcastHandle32 = _DEV_BROADCAST_HANDLE32;

  PDevBroadcastHandle64 = ^TDevBroadcastHandle64;
  ...
  TDevBroadcastHANDLE64 = _DEV_BROADCAST_HANDLE64;
...
type
  ...
  _DEV_BROADCAST_USERDEFINED = record
    ...
    dbud_szName : array [0..0] of AnsiChar; //* ASCIIZ name *// char in Dbt.h!
