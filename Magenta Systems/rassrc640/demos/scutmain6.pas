...
var
  Form1: TForm1;
  FolderList: array [0..2] of integer =
        (CSIDL_CONNECTIONS, CSIDL_PRINTERS, CSIDL_CONTROLS) ;
...
begin
    ...
    Label2.Caption := '' ;
    Label3.Caption := '' ;
    if NOT SCutSpecLink (FolderList [ListFolders.ItemIndex],
                                                ListItems.Items, '', err) then
    begin
