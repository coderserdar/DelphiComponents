...
Tested with Windows XP, 2003, Vista, 2008, 7, 8, 2012, 10, 2016, 2019 
...
11 Aug 2011 - 3.7 - ICS changes, new throttling, zlib 1.2.5, support MultiThreading
                    ...
                    while TMagFileCopyW has a new EmptyDirs property, directory attributes should be copied
...
uses
  ...
  MagentaCopy3W, MagentaFtp3W, MagentaHttp3W, MagSubs1,
  OverbyteIcsWsocket, OverbyteIcsFtpcliW, OverbyteIcsFtpSrvWT,
  OverbyteIcsHttpProt, OverbyteIcsHttpCCodzlib,
  {$IFDEF USE_SSL}OverbyteIcsSSLEAY,{$ENDIF} OverbyteIcsLogger, ExtCtrls;
...
// non-saved
  ...
  private
    ...
    procedure onCopyEvent (LogLevel: TLogLevel ; Info: UnicodeString ;
                                                  var Cancel: boolean) ;
    procedure onProgressEvent (Sender: TObject ; CopyProgress: TCopyProgressW ;
                                                  var Cancel: boolean) ;
    ...
    procedure onThreadEventW (LogLevel: TLogLevel ; const Id, Info: UnicodeString ;
                                                          var Cancel: boolean) ;
...
var
    ...
    MagFtpThreads: array [0..MaxThreads] of TMagFtpThreadW ;
...
procedure TForm1.AddLogText (S: Unicodestring) ;
begin
...
procedure TForm1.AddLogDelim (S: Unicodestring) ;
begin
...
procedure TForm1.onCopyEvent (LogLevel: TLogLevel ; Info: UnicodeString ;
                                                  var Cancel: boolean) ;
begin
...
procedure TForm1.onProgressEvent (Sender: TObject ; CopyProgress: TCopyProgressW ;
                                                  var Cancel: boolean) ;
var
    S: string ;
begin
...
procedure TForm1.onThreadEventW (LogLevel: TLogLevel ; const Id, Info: UnicodeString ;
                                                                  var Cancel: boolean) ;
begin
...
var
    MagFtpThread: TMagFtpThreadW ;
begin
    MagFtpThread := (Sender as TMagFtpThreadW) ;
...
begin
    ...
    try
        ...
        MagFtpThreads [NextThread] := TMagFtpThreadW.CreateThread ;
        result := NextThread ;
        inc (CurThreads) ;
        inc (NextThread) ;
