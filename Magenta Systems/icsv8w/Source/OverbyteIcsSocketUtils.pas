...
Sep 02, 2020 - V8.65   IcsGetInterfaceList ignores Broadcast on Posix for now.
        ...
        begin
            ...
            if Next.ifa_addr.sa_family = AF_INET then begin
             ...
             {  if Next.ifa_flags and IFF_BROADCAST = IFF_BROADCAST then
                    Move(Next.ifa_dstaddr^, PInfo^.iiBroadcastAddress.Address, SizeOf(sockaddr));   V8.65 ignore broadcast for now }
            end
            else
