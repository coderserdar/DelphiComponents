...
Jan 04, 2022 - V8.68 - BOOL to Boolean.
...
const
    FtpMultiCopyRight : String = ' TIcsFtpMultiW (c) 2022 V8.69 ';
...
procedure TIcsFtpMultiW.IcsProgEvent (Sender: TObject; LogOption: TLogOption; const Msg : String) ;   { V8.69 }
begin
...
var
    ...
    VCLUnZip: TVCLUnZip ;
    {$ENDIF}
    DelDirList: TWideStringList ;      { V8.68 looking for corruption } 
