...
const
    FormDataDecoderVersion = 867;
    CopyRight : String      = ' FormDataDecoder (c) 2003-2021 F. Piette V8.67 ';
    ...
    while TRUE do begin
        ...
        while TRUE do begin
            ...
            if Ch <> FDelimiter[I] then begin
                if I > 1 then
                    FData.Seek(1 - I, soCurrent);  { V8.67 was soFromCurrent }
                I := 1;
                Continue;
            end;
...
begin
    ...
    if not Assigned(Item) then
        ...
        SetLength(Result, Item.DataLength);
        FData.Position := Item.PosData; { V8.67 Seek(Item.PosData, soFromBeginning); }
        FData.Read(Pointer(Result)^, Item.DataLength);
    end;
end;
{$ENDIF}
