...
// (DO NOT EDIT: machine generated header) 'CSV.pas' rev: 26.00 (Android)
...
typedef System::DynamicArray<System::Byte> UTF8String;
// System::TArray__1<System::Byte> UTF8String;
...
public:
	...
	/* Exception.CreateResFmt */ inline __fastcall ECsvError(System::PResStringRec ResStringRec, System::TVarRec const *Args, const int Args_Size) : System::Sysutils::Exception(ResStringRec, Args, Args_Size) { }
	...
	/* Exception.CreateResFmtHelp */ inline __fastcall ECsvError(System::PResStringRec ResStringRec, System::TVarRec const *Args, const int Args_Size, int AHelpContext) : System::Sysutils::Exception(ResStringRec, Args, Args_Size, AHelpContext) { }
...
public:
	...
	void __fastcall LoadUtf8(const System::DynamicArray<System::Byte> Text);
	...
	System::DynamicArray<System::Byte> __fastcall ToUtf8(TCsvEndOfLine EndOfLine = (TCsvEndOfLine)(0x2));
...
private:
	...
	System::WideChar FEnclosingChar;
	System::WideChar FFieldSeparator;
	System::DynamicArray<System::Byte> FFieldSeparatorUtf8;
	// System::TArray__1<System::Byte> FFieldSeparatorUtf8;
	System::DynamicArray<System::Byte> FEndOfLine;
