...
# ---------------------------------------------------------------------------
PROJECT = Udplstn.exe
OBJFILES = Udplstn.obj \FPiette\cpp\Internet\udplstn1.obj \
   \FPiette\cpp\Internet\formpos.obj
RESFILES = UdpLstn.res
RESDEPEN = $(RESFILES) \FPiette\cpp\Internet\udplstn1.dfm
LIBFILES = 
DEFFILE = 
# ---------------------------------------------------------------------------
