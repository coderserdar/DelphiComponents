...
function ShowModalPanel(aPanel: TCustomPanel; Title: String; const ShowCloseIcon: Boolean = true; const BeforeShowModal: TNotifyEvent = Nil): TModalResult;
...
begin
  ...
  //  ModalFrm.ActiveControl := ActiveControl;
