...
uses
  ...
  cyDBAdvGrid, cyDBRichEdit, cyDBLookupComboBox, cyBaseDBClientLookupComboBox, cyDBAdvClientLookupComboBox,
...
begin
  ...
  RegisterComponents(RSVCLDBCompsPalette, [
    ...
    RegisterComponentEditor(TcyDBLookupComboBox, TcyDefaultEditor);
    RegisterComponentEditor(TcyDBClientLookupComboBox, TcyDefaultEditor);
    RegisterComponentEditor(TcyDBAdvClientLookupComboBox, TcyDefaultEditor);
