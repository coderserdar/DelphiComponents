...
uses Classes, Types, Controls, Graphics, Windows, Messages;
...
type
  ...
  protected
    ...
    procedure CMButtonPressed(var Message: TMessage); message CM_BUTTONPRESSED;  // Called in UpdateExclusive procedure ...
...
procedure TcyBaseLed.Loaded;         // !!! Not called for Dynamic controls !!!
begin
  Inherited;
...
procedure TcyBaseLed.CMButtonPressed(var Message: TMessage);
