...
// (DO NOT EDIT: machine generated header) 'WinJson.pas' rev: 5.00
...
public:
	...
	#pragma option pop
	#pragma option push -w-inl
	/* Exception.CreateFmt */ inline __fastcall EJsonError(const AnsiString Msg, const System::TVarRec * Args, const int Args_Size) : Sysutils::Exception(Msg, Args, Args_Size) { }
	#pragma option pop
	#pragma option push -w-inl
	/* Exception.CreateRes */ inline __fastcall EJsonError(int Ident)/* overload */ : Sysutils::Exception(Ident) { }
	#pragma option pop
	#pragma option push -w-inl
	/* Exception.CreateResFmt */ inline __fastcall EJsonError(int Ident, const System::TVarRec * Args, const int Args_Size)/* overload */ : Sysutils::Exception(Ident, Args, Args_Size) { }
	#pragma option pop
	#pragma option push -w-inl
	...
	#pragma option pop
	#pragma option push -w-inl
	/* Exception.CreateFmtHelp */ inline __fastcall EJsonError(const AnsiString Msg, const System::TVarRec * Args, const int Args_Size, int AHelpContext) : Sysutils::Exception(Msg, Args, Args_Size, AHelpContext) { }
	#pragma option pop
	#pragma option push -w-inl
	...
	#pragma option pop
	#pragma option push -w-inl
	/* Exception.CreateResFmtHelp */ inline __fastcall EJsonError(System::PResStringRec ResStringRec, const System::TVarRec * Args, const int Args_Size, int AHelpContext)/* overload */ : Sysutils::Exception(ResStringRec, Args, Args_Size, AHelpContext) { }
	#pragma option pop
...
private:
	...
	virtual void __fastcall Write(TStringBuilder* StringBuilder, wchar_t TabChar, int TabSize, int Indentation)/* overload */;
...
public:
	...
	WideString __fastcall ToString(bool PrettyPrint, bool UseTabChar, int TabSize);
	AnsiString __fastcall ToUtf8(bool PrettyPrint, bool UseTabChar, int TabSize);
	void __fastcall ToUtf8File(const AnsiString FileName, bool PrettyPrint, bool UseTabChar, int TabSize);
public:
	#pragma option push -w-inl
...
private:
	inline void __fastcall  Write(TStringBuilder* StringBuilder, wchar_t TabChar, int TabSize, int Indentation){ TJson::Write(StringBuilder, TabChar, TabSize, Indentation); }
...
public:
	...
	void __fastcall SetDateTime(int Index, const System::TDateTime Value, int Offset);
...
public:
	...
	void __fastcall SetDateTime(const WideString Name, const System::TDateTime Value, int Offset);
...
public:
	...
	void __fastcall Append(wchar_t Value)/* overload */;
...
private:
	...
	wchar_t __fastcall Current(void);
	...
	void __fastcall Read(wchar_t C);
