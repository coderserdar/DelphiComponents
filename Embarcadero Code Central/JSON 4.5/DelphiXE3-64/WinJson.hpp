...
// (DO NOT EDIT: machine generated header) 'WinJson.pas' rev: 24.00 (Win64)
...
typedef System::WideChar WideChar;
...
public:
	...
	/* Exception.CreateFmt */ inline __fastcall EJsonError(const System::UnicodeString Msg, System::TVarRec const *Args, const int Args_Size) : System::Sysutils::Exception(Msg, Args, Args_Size) { }
	...
	/* Exception.CreateResFmt */ inline __fastcall EJsonError(NativeUInt Ident, System::TVarRec const *Args, const int Args_Size)/* overload */ : System::Sysutils::Exception(Ident, Args, Args_Size) { }
	/* Exception.CreateResFmt */ inline __fastcall EJsonError(System::PResStringRec ResStringRec, System::TVarRec const *Args, const int Args_Size)/* overload */ : System::Sysutils::Exception(ResStringRec, Args, Args_Size) { }
	...
	/* Exception.CreateFmtHelp */ inline __fastcall EJsonError(const System::UnicodeString Msg, System::TVarRec const *Args, const int Args_Size, int AHelpContext) : System::Sysutils::Exception(Msg, Args, Args_Size, AHelpContext) { }
	...
	/* Exception.CreateResFmtHelp */ inline __fastcall EJsonError(System::PResStringRec ResStringRec, System::TVarRec const *Args, const int Args_Size, int AHelpContext)/* overload */ : System::Sysutils::Exception(ResStringRec, Args, Args_Size, AHelpContext) { }
	/* Exception.CreateResFmtHelp */ inline __fastcall EJsonError(NativeUInt Ident, System::TVarRec const *Args, const int Args_Size, int AHelpContext)/* overload */ : System::Sysutils::Exception(Ident, Args, Args_Size, AHelpContext) { }
...
public:
	...
	TJson* __fastcall ParseUtf8(const System::DynamicArray<System::Byte> Utf8)/* overload */;
	TJson* __fastcall ParseAnsi(const System::DynamicArray<System::Byte> Ansi)/* overload */;
...
enum TJsonItem : unsigned char { itEof, itNull, itFalse, itTrue, itNumber, itString, itBeginArray, itEndArray, itBeginObject, itEndObject };
...
public:
	...
	__fastcall TJsonReader(const System::DynamicArray<System::Byte> Data, bool Utf8)/* overload */;
