...
// (DO NOT EDIT: machine generated header) 'Winjson.pas' rev: 20.00
...
public:
	/* Exception.Create */ inline __fastcall EJsonError(const System::UnicodeString Msg) : Sysutils::Exception(Msg) { }
	/* Exception.CreateFmt */ inline __fastcall EJsonError(const System::UnicodeString Msg, System::TVarRec const *Args, const int Args_Size) : Sysutils::Exception(Msg, Args, Args_Size) { }
	...
	/* Exception.CreateHelp */ inline __fastcall EJsonError(const System::UnicodeString Msg, int AHelpContext) : Sysutils::Exception(Msg, AHelpContext) { }
	/* Exception.CreateFmtHelp */ inline __fastcall EJsonError(const System::UnicodeString Msg, System::TVarRec const *Args, const int Args_Size, int AHelpContext) : Sysutils::Exception(Msg, Args, Args_Size, AHelpContext) { }
...
private:
	typedef DynamicArray<TJson*> _TJsonArray__1;
...
private:
	typedef DynamicArray<TJsonMember> _TJsonObject__1;
...
public:
	...
	TJson* __fastcall ParseUtf8(const Sysutils::TBytes Utf8)/* overload */;
	TJson* __fastcall ParseAnsi(const Sysutils::TBytes Ansi)/* overload */;
...
private:
	typedef DynamicArray<bool> _TJsonWriter__1;
...
private:
	typedef DynamicArray<bool> _TJsonReader__1;
...
public:
	...
	__fastcall TJsonReader(const Sysutils::TBytes Data, bool Utf8)/* overload */;
