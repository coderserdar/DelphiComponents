...
uses
  ...
  IdCoderMIME, IdCoderXXE, IdCoder, IdCoder3to4, IdCoderUUE,
  IdBaseComponent, IdMessageCoderUUE;
...
var
  IDUUDecoder1: TIdMessageDecoderUUE;
  IDUUEncoder1: TIdEncoderUUE;
  s, k, x: String;
     ...
     begin
      Total_Contents := 0;
       begin
        ...
        fz           := FileSize(tf);
        fn           := '';
        IDUUDecoder1 := TIdMessageDecoderUUE.Create(NIL);
