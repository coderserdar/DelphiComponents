...
// (DO NOT EDIT: machine generated header) 'DBGridEh.pas' rev: 4.00
...
enum TColumnEhValue { cvColor, cvWidth, cvFont, cvAlignment, cvReadOnly, cvTitleColor, cvTitleCaption, 
	cvTitleAlignment, cvTitleFont, cvTitleButton, cvTitleEndEllipsis, cvTitleToolTips, cvTitleOrientation, 
	cvImeMode, cvImeName, cvWordWrap, cvLookupDisplayFields, cvCheckboxes, cvAlwaysShowEditButton, cvEndEllipsis, 
	cvAutoDropDown, cvDblClickNextVal, cvToolTips, cvDropDownSizing, cvDropDownShowTitles };
#pragma option pop
...
#pragma option push -b-
enum TColumnEhRestoreParam { crpColIndexEh, crpColWidthsEh, crpSortMarkerEh, crpColVisibleEh, crpDropDownRowsEh, 
	crpDropDownWidthEh };
#pragma option pop
...
#pragma option push -b-
enum TDBLookupGridEhOption { dlgColumnResizeEh, dlgColLinesEh, dlgRowLinesEh, dlgAutoSortMarkingEh, 
	dlgMultiSortMarkingEh };
#pragma option pop
...
__interface ILookupGridOwner  : public IUnknown /* __guid="{2A1F4552-15C3-4359-ADAB-F2F6719FAA97}" */
...
__published:
	...
	__property bool EndEllipsis = {read=GetEndEllipsis, write=SetEndEllipsis, stored=IsEndEllipsisStored
		, nodefault};
	...
	__property TTextOrientationEh Orientation = {read=GetOrientation, write=SetOrientation, stored=IsOrientationStored
		, nodefault};
	...
	__property bool TitleButton = {read=GetTitleButton, write=SetTitleButton, stored=IsTitleButtonStored
		, nodefault};
...
public:
	#pragma option push -w-inl
	/* TColumnDefValuesEh.Create */ inline __fastcall TDBGridEhColumnDefValuesEh(TCustomDBGridEh* Grid)
		 : TColumnDefValuesEh(Grid) { }
	#pragma option pop
	#pragma option push -w-inl
...
#pragma option push -b-
enum TSTFilterOperatorEh { foNon, foEqual, foNotEqual, foGreaterThan, foLessThan, foGreaterOrEqual, 
	foLessOrEqual, foLike, foNotLike, foIn, foNotIn, foNull, foNotNull, foAND, foOR, foValue };
#pragma option pop
...
typedef void __fastcall (__closure *TGetColCellParamsEventEh)(System::TObject* Sender, bool EditMode
	, TColCellParamsEh* Params);

typedef void __fastcall (__closure *TColCellUpdateDataEventEh)(System::TObject* Sender, AnsiString &
	Text, Variant &Value, bool &UseText, bool &Handled);
...
public:
	...
	__property Classes::TAlignment Alignment = {read=GetAlignment, write=SetAlignment, stored=IsAlignmentStored
		, nodefault};
	__property bool AlwaysShowEditButton = {read=GetAlwaysShowEditButton, write=SetAlwaysShowEditButton
		, stored=IsAlwaysShowEditButtonStored, nodefault};
	__property bool AutoDropDown = {read=GetAutoDropDown, write=SetAutoDropDown, stored=IsAutoDropDownStored
		, nodefault};
	...
	__property bool DblClickNextVal = {read=GetDblClickNextVal, write=SetDblClickNextVal, stored=IsDblClickNextValStored
		, nodefault};
	__property AnsiString DisplayFormat = {read=FDisplayFormat, write=SetDisplayFormat};
	...
	__property bool DropDownShowTitles = {read=GetDropDownShowTitles, write=SetDropDownShowTitles, stored=
		IsDropDownShowTitlesStored, nodefault};
	__property bool DropDownSizing = {read=GetDropDownSizing, write=SetDropDownSizing, stored=IsDropDownSizingStored
		, nodefault};
	...
	__property TCheckTitleEhBtnEvent OnDropDownBoxCheckButton = {read=GetOnDropDownBoxCheckButton, write=
		SetOnDropDownBoxCheckButton};
	__property TDrawColumnEhCellEvent OnDropDownBoxDrawColumnCell = {read=GetOnDropDownBoxDrawColumnCell
		, write=SetOnDropDownBoxDrawColumnCell};
	__property TGetCellEhParamsEvent OnDropDownBoxGetCellParams = {read=GetOnDropDownBoxGetCellParams, 
	...
	__property TTitleEhClickEvent OnDropDownBoxTitleBtnClick = {read=GetOnDropDownBoxTitleBtnClick, write=
		SetOnDropDownBoxTitleBtnClick};
...
public:
	#pragma option push -w-inl
	/* TColumnEh.Create */ inline __fastcall virtual TDBGridColumnEh(Classes::TCollection* Collection) : 
		TColumnEh(Collection) { }
	#pragma option pop
	#pragma option push -w-inl
...
#pragma pack(push, 4)
class PASCALIMPLEMENTATION TColumnsEhList : public Toolctrlseh::TObjectList 
{
	typedef Toolctrlseh::TObjectList inherited;
...
__published:
	...
	__property VisibleMode ;
public:
	#pragma option push -w-inl
	/* TDBGridEhScrollBar.Create */ inline __fastcall TVertDBGridEhScrollBar(TCustomDBGridEh* AGrid, Forms::TScrollBarKind 
		AKind) : TDBGridEhScrollBar(AGrid, AKind) { }
	#pragma option pop
	#pragma option push -w-inl
...
enum TDBGridEhOption { dghFixed3D, dghFrozen3D, dghFooter3D, dghData3D, dghResizeWholeRightPart, dghHighlightFocus, 
	dghClearSelection, dghFitRowHeightToText, dghAutoSortMarking, dghMultiSortMarking, dghEnterAsTab, dghTraceColSizing, 
	dghIncSearch, dghPreferIncSearch, dghRowHighlight, dghDblClickOptimizeColWidth, dghDialogFind };
#pragma option pop
...
private:
	Toolctrlseh::TObjectList* FGrids;
...
protected:
	virtual bool __fastcall HighlightDataCellColor(TCustomDBGridEh* AGrid, int ACol, int ARow, int DataCol
		, int DataRow, const AnsiString Value, Grids::TGridDrawState AState, bool InMultiSelect, Graphics::TColor 
		&AColor, Graphics::TFont* AFont);
	virtual bool __fastcall HighlightNoDataCellColor(TCustomDBGridEh* AGrid, int ACol, int ARow, int DataCol
		, int DataRow, TCellTypeEh CellType, Grids::TGridDrawState AState, bool InMultiSelect, Graphics::TColor 
		&AColor, Graphics::TFont* AFont);
...
public:
	...
	Graphics::TColor __fastcall LightenColor(Graphics::TColor AColor, Graphics::TColor GlassColor, bool 
		Ungray);
	...
	__property bool FilterEditCloseUpApplyFilter = {read=FFilterEditCloseUpApplyFilter, write=FFilterEditCloseUpApplyFilter
		, default=0};
...
private:
	...
	void __fastcall DrawEdgeEh(Graphics::TCanvas* ACanvas, const Windows::TRect &qrc, bool IsDown, bool 
		IsSelected, bool NeedLeft, bool NeedRight);
	...
	void __fastcall PaintInplaceButton(Graphics::TCanvas* Canvas, Toolctrlseh::TEditButtonStyleEh ButtonStyle
		, const Windows::TRect &Rect, const Windows::TRect &ClipRect, int DownButton, bool Active, bool Flat
		, bool Enabled, Graphics::TColor ParentColor, Graphics::TBitmap* Bitmap);
	
protected:
	bool __fastcall InplaceEditCanModify(Controls::TWinControl* Control);
	void __fastcall GetMouseDownInfo(Windows::TPoint &Pos, int &Time);
	void __fastcall InplaceEditKeyDown(Controls::TWinControl* Control, Word &Key, Classes::TShiftState 
		Shift);
	...
	HIDESBASE Windows::TRect __fastcall BoxRect(int ALeft, int ATop, int ARight, int ABottom);
	...
	virtual bool __fastcall HighlightNoDataCellColor(int ACol, int ARow, int DataCol, int DataRow, TCellTypeEh 
		CellType, Grids::TGridDrawState AState, bool InMultiSelect, Graphics::TColor &AColor, Graphics::TFont* 
		AFont);
	...
	virtual void __fastcall DrawCell(int ACol, int ARow, const Windows::TRect &ARect, Grids::TGridDrawState 
		AState);
	virtual void __fastcall DrawCellTreeArea(int DataCol, int DataRow, Grids::TGridDrawState AState, const 
		Windows::TRect &ARect);
	void __fastcall DrawTreeArea(Graphics::TCanvas* Canvas, const Windows::TRect &ARect);
	...
	DYNAMIC void __fastcall DrawDataCell(const Windows::TRect &Rect, Db::TField* Field, Grids::TGridDrawState 
		State);
	virtual void __fastcall DrawSubTitleCell(int ACol, int ARow, int DataCol, int DataRow, TCellTypeEh 
	...
	void __fastcall PaintButtonControl(HDC DC, const Windows::TRect &ARect, Graphics::TColor ParentColor
		, Toolctrlseh::TDrawButtonControlStyleEh Style, int DownButton, bool Flat, bool Active, bool Enabled
	...
	void __fastcall WriteCellText(Graphics::TCanvas* ACanvas, const Windows::TRect &ARect, bool FillRect
		, int DX, int DY, AnsiString Text, Classes::TAlignment Alignment, Stdctrls::TTextLayout Layout, bool 
		MultyL, bool EndEllipsis, int LeftMarg, int RightMarg);
	...
	bool __fastcall CheckCellFilter(int ACol, int ARow, const Windows::TPoint &P);
...
public:
	...
	void __fastcall RestoreColumnsLayout(Inifiles::TCustomIniFile* ACustIni, AnsiString Section, TColumnEhRestoreParams 
		RestoreParams)/* overload */;
	...
	void __fastcall RestoreColumnsLayoutIni(AnsiString IniFileName, AnsiString Section, TColumnEhRestoreParams 
		RestoreParams);
	void __fastcall RestoreGridLayout(Inifiles::TCustomIniFile* ARegIni, AnsiString Section, TDBGridEhRestoreParams 
		RestoreParams)/* overload */;
	...
	__property TDBGridEhAllowedOperations AllowedOperations = {read=FAllowedOperations, write=FAllowedOperations
		, default=15};
	__property TDBGridEhAllowedSelections AllowedSelections = {read=FAllowedSelections, write=SetAllowedSelections
		, default=30};
...
public:
	operator IUnknown*(void) { return (IUnknown*)&__IInplaceEditHolderEh; }
...
//-- var, const, procedure ---------------------------------------------------
#define ColumnEhTitleValues (System::Set<TColumnEhValue, cvColor, cvDropDownShowTitles> () << cvTitleColor \
	<< cvTitleCaption << cvTitleAlignment << cvTitleFont << cvTitleButton << cvTitleEndEllipsis << cvTitleToolTips \
	<< cvTitleOrientation )
#define ColumnEhFooterValues (System::Set<TColumnFooterEhValue, cvFooterAlignment, cvFooterToolTips> () \
	<< cvFooterAlignment << cvFooterFont << cvFooterColor )
...
extern PACKAGE void __fastcall WriteTextEh(Graphics::TCanvas* ACanvas, const Windows::TRect &ARect, 
	...
	Layout, bool MultyL, bool EndEllipsis, int LeftMarg, int RightMarg, bool RightToLeftReading);
extern PACKAGE int __fastcall WriteTextVerticalEh(Graphics::TCanvas* ACanvas, const Windows::TRect &
	ARect, bool FillRect, int DX, int DY, AnsiString Text, Classes::TAlignment Alignment, Stdctrls::TTextLayout 
	Layout, bool EndEllipsis, bool CalcTextExtent);
