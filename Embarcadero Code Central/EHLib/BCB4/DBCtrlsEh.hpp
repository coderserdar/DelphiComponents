...
// (DO NOT EDIT: machine generated header) 'DBCtrlsEh.pas' rev: 4.00
...
__interface IInplaceEditHolderEh  : public IUnknown /* __guid="{4BE708F1-4EA2-4AC7-BA64-89D7D2B83E09}" */
...
__interface IInplaceEditEh  : public IUnknown /* __guid="{81F0C558-B001-4477-BAA6-2DC373FCDF88}" */
{
...
private:
	...
	void __fastcall SetField(Toolctrlseh::TObjectList* Value);
