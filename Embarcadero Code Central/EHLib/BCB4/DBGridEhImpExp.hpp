...
// (DO NOT EDIT: machine generated header) 'DBGridEhImpExp.pas' rev: 4.00
...
protected:
	...
	virtual void __fastcall WriteFooterCell(int DataCol, int Row, Dbgrideh::TColumnEh* Column, Graphics::TFont* 
		AFont, Graphics::TColor Background, Classes::TAlignment Alignment, AnsiString Text);
...
private:
	...
	Graphics::TColor __fastcall GetFooterCellColor(Dbgrideh::TColumnsEhList* ColumnsList, int ColIndex, 
		int FooterNo);
...
extern PACKAGE void __fastcall WriteDBGridEhToExportStream(TMetaClass* ExportClass, Dbgrideh::TCustomDBGridEh* 
	DBGridEh, Classes::TStream* Stream, bool IsSaveAll);
extern PACKAGE void __fastcall SaveDBGridEhToExportFile(TMetaClass* ExportClass, Dbgrideh::TCustomDBGridEh* 
	DBGridEh, const AnsiString FileName, bool IsSaveAll);
extern PACKAGE void __fastcall LoadDBGridEhFromImportFile(TMetaClass* ImportClass, Dbgrideh::TCustomDBGridEh* 
	DBGridEh, const AnsiString FileName, bool IsLoadToAll);
extern PACKAGE void __fastcall ReadDBGridEhFromImportStream(TMetaClass* ImportClass, Dbgrideh::TCustomDBGridEh* 
	DBGridEh, Classes::TStream* Stream, bool IsLoadToAll);
