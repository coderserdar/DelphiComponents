...
// (DO NOT EDIT: machine generated header) 'CalculatorEh.pas' rev: 5.00
...
__interface INTERFACE_UUID("{697F81AD-0E0F-4A4A-A016-A713620660DE}") IPopupCalculatorEh  : public IUnknown 
