...
// (DO NOT EDIT: machine generated header) 'ToolCtrlsEh.pas' rev: 5.00
...
__interface INTERFACE_UUID("{A8C3C87A-E556-4BDB-B8A7-5B33497D1624}") IMemTableEh  : public IUnknown 
...
__interface INTERFACE_UUID("{B64255B5-386A-4524-8BC7-7F49DDB410F4}") IComboEditEh  : public IUnknown 
...
protected:
	...
	virtual void __fastcall CreateWnd(void);
	virtual void __fastcall DrawBorder(void);
	virtual void __fastcall DrawItem(int Index, const Windows::TRect &ARect, Windows::TOwnerDrawState State
		);
...
typedef Set<Db::TFieldType, ftUnknown, ftGuid>  TFieldTypes;
