...
// (DO NOT EDIT: machine generated header) 'EhLibVCL.pas' rev: 6.00
...
extern PACKAGE HRGN __fastcall WindowsCreatePolygonRgn(const Types::TPoint * Points, const int Points_Size, int Count, int FillMode);
...
extern PACKAGE System::TObject* __fastcall GetObjectProp(System::TObject* Instance, Typinfo::PPropInfo PropInfo);
extern PACKAGE TMetaClass* __fastcall GetObjectPropClass(System::TObject* Instance, Typinfo::PPropInfo PropInfo);
extern PACKAGE void __fastcall SetObjectProp(System::TObject* Instance, Typinfo::PPropInfo PropInfo, System::TObject* Value);
