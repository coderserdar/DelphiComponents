...
// (DO NOT EDIT: machine generated header) 'DBLookupGridsEh.pas' rev: 6.00
...
protected:
	...
	virtual void __fastcall DrawSubTitleCell(int ACol, int ARow, int DataCol, int DataRow, Dbgrideh::TCellTypeEh CellType, const Types::TRect &ARect, Grids::TGridDrawState AState, bool &Highlighted);
