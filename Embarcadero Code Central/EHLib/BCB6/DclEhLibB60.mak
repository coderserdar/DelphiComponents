...
VERSION = BCB.06.00
# ---------------------------------------------------------------------------
PROJECT = DclEhLibB60.bpl
OBJFILES = DclEhLibB60.obj RichEdEh.obj EhLibReg.obj GridEhEd.obj PropStorageEditEh.obj
RESFILES = DclEhLibB60.res EhLibReg.dcr
MAINSOURCE = DclEhLibB60.cpp
RESDEPEN = $(RESFILES) RichEdEh.dfm PropStorageEditEh.dfm
LIBFILES = 
IDLFILES = 
IDLGENFILES = 
...
PACKAGES = rtl.bpi designide.bpi vcl.bpi dbrtl.bpi vclx.bpi vcldb.bpi EhLibB60.bpi
...
INCLUDEPATH = ..\Projects;$(BCB)\include;$(BCB)\include\vcl
LIBPATH = $(BCB)\Projects\Lib;..\lib\release;..\Projects;$(BCB)\lib\obj;$(BCB)\lib
WARNINGS= -w-par
PATHCPP = .;
PATHASM = .;
PATHPAS = .;
...
CFLAG1 = -Od -H=$(BCB)\lib\vcl60.csm -Hc -Vx -Ve -X- -r- -a8 -b- -k -y -v -vi- -c \
    -tWM
IDLCFLAGS = -I..\Projects -I$(BCB)\include -I$(BCB)\include\vcl -src_suffix cpp \
    -D_DEBUG -boa
PFLAGS = -$YD -$L- -$D- -$A8 -LUdclstd -v -JPHNE -M
RFLAGS = 
AFLAGS = /mx /w2 /zd
LFLAGS = -D"EhLib 3.4 Components" -aa -Tpp -Gpd -x -Gn -Gl -Gi
# ---------------------------------------------------------------------------
