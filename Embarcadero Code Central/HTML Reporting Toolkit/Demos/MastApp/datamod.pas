...
type
  TMastData = class(TDataModule)
    ...
    CustByLastInvQueryAddr: TStringField;
    ...
    procedure CustByLastInvQueryCalcFields(DataSet: TDataSet);
...
procedure TMastData.CustByLastInvQueryCalcFields(DataSet: TDataSet);
begin
  CustByLastInvQueryAddr.AsString := CustByLastInvQueryAddr1.AsString;
  if CustByLastInvQueryAddr2.AsString <> '' then
    CustByLastInvQueryAddr.AsString := CustByLastInvQueryAddr.AsString + ', ' + CustByLastInvQueryAddr2.AsString;
  if CustByLastInvQueryCity.AsString <> '' then
    CustByLastInvQueryAddr.AsString := CustByLastInvQueryAddr.AsString + ', ' + CustByLastInvQueryCity.AsString;
end;

procedure TMastData.CustCalcFields(DataSet: TDataSet);
begin
  CustAddr.AsString := CustAddr1.AsString;
  if CustAddr2.AsString <> '' then
    CustAddr.AsString := CustAddr.AsString + ', ' + CustAddr2.AsString;
  if CustCity.AsString <> '' then
    CustAddr.AsString := CustAddr.AsString + ', ' + CustCity.AsString;
end;
