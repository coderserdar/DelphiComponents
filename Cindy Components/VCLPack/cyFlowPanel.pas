...
//    property Color;
    ...
    property DockSite;
    {$IFDEF UNICODE} property DoubleBuffered; {$ENDIF}
    property DragCursor;
    property DragKind;
    property DragMode;
    property Enabled;
    {$IFDEF UNICODE} property FlowStyle; {$ENDIF}
    property FullRepaint;
    property Font;
    property Locked;
    {$IFDEF UNICODE} property Padding; {$ENDIF}
...
//    property ParentColor;
    ...
    property PopupMenu;
    {$IFDEF UNICODE} property ShowCaption; {$ENDIF}
    property ShowHint;
    property TabOrder;
    property TabStop;
