...
uses StdCtrls, Graphics, classes, Windows, Messages, Controls, DB, DBCtrls, cyHotLabel;
...
procedure TcyDBHotLabel.Loaded;          // !!! Not called for Dynamic controls !!!
begin
  inherited Loaded;
  // Show component name ...
...
procedure TcyDBHotLabel.CMGetDataLink(var Message: TMessage);
begin
