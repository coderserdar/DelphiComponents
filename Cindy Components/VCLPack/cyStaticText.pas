...
type
  ...
  published
    ...
    {$IFDEF UNICODE} property ParentDoubleBuffered; {$ENDIF}
    property ParentFont;
    ...
    property OnEndDock;
    property OnEndDrag;
    {$IFDEF UNICODE} property OnMouseActivate; {$ENDIF}
    property OnMouseDown;
    {$IFDEF UNICODE} property OnMouseEnter; {$ENDIF}
    {$IFDEF UNICODE} property OnMouseLeave; {$ENDIF}
